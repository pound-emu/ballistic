...
inline int
Edit(Light *lights, int lightCount, int selected = -1, ImVec2 size = ImVec2(0, 0))
{
    ...
    draw_list->AddLine(ImVec2(canvas_pos.x + controlWidth * 0.5f, canvas_pos.y),
                       ImVec2(canvas_pos.x + controlWidth * 0.5f, canvas_pos.y + controlWidth),
                       0xFFAAAAAA);
    draw_list->AddLine(ImVec2(canvas_pos.x, canvas_pos.y + controlWidth * 0.5f),
                       ImVec2(canvas_pos.x + controlWidth, canvas_pos.y + controlWidth * 0.5f),
                       0xFFAAAAAA);
    draw_list->AddCircle(
        ImVec2(canvas_pos.x + controlWidth * 0.5f, canvas_pos.y + controlWidth * 0.5f),
        controlWidth * 0.5f,
        0xFFAAAAAA);
    ...
    for (int i = 0; i < lightCount; i++)
    {
        auto      &light = lights[i];
        const auto center(
            ImVec2(canvas_pos.x + controlWidth * 0.5f + light.x * controlWidth * 0.5f,
