...
private:
    ...
    inline bool isSavable() const
    {
        return isDirty() && filename != "untitled";
    }
    ...
    inline void increaseFontSIze()
    {
        fontSize = std::clamp(fontSize + 1.0f, 8.0f, 24.0f);
    }
    inline void decreaseFontSIze()
    {
        fontSize = std::clamp(fontSize - 1.0f, 8.0f, 24.0f);
    }
