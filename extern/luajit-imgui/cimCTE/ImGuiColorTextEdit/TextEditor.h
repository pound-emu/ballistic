...
public:
    ...
    {
        return document.getTabSize();
    }
    inline void SetInsertSpacesOnTabs(bool value)
    {
        document.setInsertSpacesOnTabs(value);
    }
    inline bool IsInsertSpacesOnTabs() const
    {
    ...
    inline void SetAutoIndentEnabled(bool value)
    {
        autoIndent = value;
    }
    ...
    inline void SetShowWhitespacesEnabled(bool value)
    {
        showSpaces = value;
        showTabs   = value;
    }
    ...
    {
        return showSpaces && showTabs;
    }
    inline void SetShowSpacesEnabled(bool value)
    {
        showSpaces = value;
    }
    inline bool IsShowSpacesEnabled() const
    {
        return showSpaces;
    }
    inline void SetShowTabsEnabled(bool value)
    {
        showTabs = value;
    }
    inline bool IsShowTabsEnabled() const
    {
        return showTabs;
    }
    ...
    inline void SetShowScrollbarMiniMapEnabled(bool value)
    {
        showScrollbarMiniMap = value;
    }
    inline bool IsShowScrollbarMiniMapEnabled() const
    {
        return showScrollbarMiniMap;
    }
    inline void SetShowPanScrollIndicatorEnabled(bool value)
    {
        showPanScrollIndicator = value;
    }
    inline bool IsShowPanScrollIndicatorEnabled() const
    {
        return showPanScrollIndicator;
    }
    inline void SetShowMatchingBrackets(bool value)
    {
        showMatchingBrackets        = value;
        showMatchingBracketsChanged = true;
    }
    inline bool IsShowingMatchingBrackets() const
    {
        return showMatchingBrackets;
    }
    inline void SetCompletePairedGlyphs(bool value)
    {
        completePairedGlyphs = value;
    }
    inline bool IsCompletingPairedGlyphs() const
    {
        return completePairedGlyphs;
    }
    inline void SetOverwriteEnabled(bool value)
    {
        overwrite = value;
    }
    ...
    inline void SetMiddleMousePanMode()
    {
        panMode = true;
    }
    inline void SetMiddleMouseScrollMode()
    {
        panMode = false;
    }
    inline bool IsMiddleMousePanMode() const
    {
        return panMode;
    }
    ...
    {
        return (line < 0 || line > static_cast<int>(document.size())) ? ""
                                                                      : document.getLineText(line);
    }

    inline std::string GetSectionText(int startLine,
                                      int startColumn,
                                      int endLine,
                                      int endColumn) const
    {
    ...
    inline void ReplaceSectionText(
        int startLine, int startColumn, int endLine, int endColumn, const std::string_view &text)
    {
        return replaceSectionText(document.normalizeCoordinate(Coordinate(startLine, startColumn)),
                                  document.normalizeCoordinate(Coordinate(endLine, endColumn)),
                                  text);
    }
    ...
    inline void Render(const char *title, const ImVec2 &size = ImVec2(), bool border = false)
    {
    ...
    {
        return !readOnly && transactions.canUndo();
    };
    inline bool CanRedo() const
    {
        return !readOnly && transactions.canRedo();
    };
    inline size_t GetUndoIndex() const
    {
        return transactions.getUndoIndex();
    };

    // manipulate cursors and selections (line numbers are zero-based)
    inline void SetCursor(int line, int column)
    {
        moveTo(document.normalizeCoordinate(Coordinate(line, column)), false);
    }
    inline void SelectAll()
    {
        selectAll();
    }
    inline void SelectLine(int line)
    {
    ...
    inline void SelectLines(int start, int end)
    {
        if (start >= 0 && end < document.lineCount() && start <= end)
        {
    ...
    inline void SelectToBrackets(bool includeBrackets = true)
    {
        selectToBrackets(includeBrackets);
    }
    inline void GrowSelectionsToCurlyBrackets()
    {
        growSelectionsToCurlyBrackets();
    }
    inline void ShrinkSelectionsToCurlyBrackets()
    {
        shrinkSelectionsToCurlyBrackets();
    }
    inline void AddNextOccurrence()
    {
        addNextOccurrence();
    }
    inline void SelectAllOccurrences()
    {
        selectAllOccurrences();
    }
    inline bool AnyCursorHasSelection() const
    {
        return cursors.anyHasSelection();
    }
    inline bool AllCursorsHaveSelection() const
    {
        return cursors.allHaveSelection();
    }
    inline bool CurrentCursorHasSelection() const
    {
        return cursors.currentCursorHasSelection();
    }
    ...
    inline size_t GetNumberOfCursors() const
    {
        return cursors.size();
    }
    inline void GetCursor(int &line, int &column, size_t cursor) const
    {
        return getCursor(line, column, cursor);
    }
    inline void GetCursor(
        int &startLine, int &startColumn, int &endLine, int &endColumn, size_t cursor) const
    {
        return getCursor(startLine, startColumn, endLine, endColumn, cursor);
    }
    inline void GetMainCursor(int &line, int &column) const
    {
        return getCursor(line, column, cursors.getMainIndex());
    }
    inline void GetCurrentCursor(int &line, int &column) const
    {
        return getCursor(line, column, cursors.getCurrentIndex());
    }

    // alternative API for cursor and selection position using lightweight out struct (line and
    // column are zero-based)
    struct CursorPosition
    {
        CursorPosition() = default;
        CursorPosition(int l, int c)
            : line(l)
            , column(c)
        {
        }
    ...
    struct CursorSelection
    {
        ...
        CursorSelection(CursorPosition s, CursorPosition e)
            : start(s)
            , end(e)
        {
        }
    ...
    inline CursorPosition GetMainCursorPosition() const
    {
        CursorPosition p;
        getCursor(p.line, p.column, cursors.getMainIndex());
        return p;
    }
    inline CursorPosition GetCurrentCursorPosition() const
    {
        CursorPosition p;
        getCursor(p.line, p.column, cursors.getCurrentIndex());
        return p;
    }
    inline CursorPosition GetCursorPosition(size_t cursor) const
    {
        CursorPosition p;
        getCursor(p.line, p.column, cursor);
        return p;
    }
    inline CursorSelection GetCursorSelection(size_t cursor) const
    {
        CursorSelection s;
        getCursor(s.start.line, s.start.column, s.end.line, s.end.column, cursor);
        return s;
    }
    inline CursorSelection GetMainCursorSelection() const
    {
        return GetCursorSelection(cursors.getMainIndex());
    }
    ...
    inline void ScrollToLine(int line, Scroll alignment)
    {
        scrollToLine(line, alignment);
    }
    ...
    inline int GetFirstVisibleColumn() const
    {
        return firstVisibleColumn;
    }
    inline int GetLastVisibleColumn() const
    {
    ...
    inline float GetGlyphWidth() const
    {
        return glyphSize.x;
    }
    ...
    // this is because we can only do layout calculations when we are in a Dear ImGui drawing
    // context as a result, SetCursor or ScrollToLine just mark the request and let Render execute
    // it
    //
    ...
    // * then call SetCursor as it sets the cursor and requests that we make the cursor visible
    // (i.e. scroll to it)
    // * then call ScrollToLine to mark the exact scroll location (it cancels the possible SetCursor
    // scroll request)
    ...
    inline void SelectFirstOccurrenceOf(const std::string_view &text,
                                        bool                    caseSensitive = true,
                                        bool                    wholeWord     = false)
    {
        selectFirstOccurrenceOf(text, caseSensitive, wholeWord);
    }
    inline void SelectNextOccurrenceOf(const std::string_view &text,
                                       bool                    caseSensitive = true,
                                       bool                    wholeWord     = false)
    {
        selectNextOccurrenceOf(text, caseSensitive, wholeWord);
    }
    inline void SelectAllOccurrencesOf(const std::string_view &text,
                                       bool                    caseSensitive = true,
                                       bool                    wholeWord     = false)
    {
        selectAllOccurrencesOf(text, caseSensitive, wholeWord);
    }
    inline void ReplaceTextInCurrentCursor(const std::string_view &text)
    {
        if (!readOnly)
        {
            replaceTextInCurrentCursor(text);
        }
    }
    inline void ReplaceTextInAllCursors(const std::string_view &text)
    {
        if (!readOnly)
        {
            replaceTextInAllCursors(text);
        }
    }

    inline void OpenFindReplaceWindow()
    {
        openFindReplace();
    }
    inline void CloseFindReplaceWindow()
    {
        closeFindReplace();
    }
    inline void SetFindButtonLabel(const std::string_view &label)
    {
        findButtonLabel = label;
    }
    inline void SetFindAllButtonLabel(const std::string_view &label)
    {
        findAllButtonLabel = label;
    }
    inline void SetReplaceButtonLabel(const std::string_view &label)
    {
        replaceButtonLabel = label;
    }
    inline void SetReplaceAllButtonLabel(const std::string_view &label)
    {
        replaceAllButtonLabel = label;
    }
    inline bool HasFindString() const
    {
        return findText.size();
    }
    ...
    inline void AddMarker(int                     line,
                          ImU32                   lineNumberColor,
                          ImU32                   textColor,
                          const std::string_view &lineNumberTooltip,
                          const std::string_view &textTooltip)
    {
        addMarker(line, lineNumberColor, textColor, lineNumberTooltip, textTooltip);
    }
    ...
    // the delay parameter specifies a time in miliseconds that the editor will wait for before
    // calling which helps in case you don't need to track every keystroke passing nullptr
    ...
    // this callback is different from the one above as is reports every change (not just a summary)
    // and is very detailed the insert flag states whether the change was an insert (true) or a
    // delete (false) in case of an overwrite, there will be two actions (first a delete and then an
    // insert) the start parameters refer to the insert point or the start of the delete the end
    // parameters refer to the end of the inserted text or the end of the deleted text the text
    // parameter contains the inserted or deleted text line, column and index values are zero-based
    struct Change
    {
        bool        insert;
        int         startLine;
    ...
    // it provides a list of changes made to the document in a single transaction (in the right
    // order) be carefull with this callback as it gets very verbose (called on every keystroke,
    // delete, cut, paste, undo and redo) passing nullptr deactivates the callback
    inline void SetTransactionCallback(std::function<void(std::vector<Change> &)> callback)
    {
        transactionCallback = callback;
    }

    // line-based callbacks (line numbers are zero-based)
    // insertor callback is called when for each line inserted and the result is used as the new
    // line specific user data deletor callback is called for each line deleted (line specific user
    // data is passed to callback) setting either callback to nullptr will deactivate that callback
    inline void SetInsertor(std::function<void *(int line)> callback)
    {
        document.setInsertor(callback);
    }
    inline void SetDeletor(std::function<void(int line, void *data)> callback)
    {
        document.setDeletor(callback);
    }
    ...
    inline void SetUserData(int line, void *data)
    {
        document.setUserData(line, data);
    }
    inline void *GetUserData(int line) const
    {
        return document.getUserData(line);
    }
    inline void IterateUserData(std::function<void(int line, void *data)> callback) const
    {
        document.iterateUserData(callback);
    }
    ...
    {
        SetLineDecorator(0.0f, nullptr);
    }
    inline bool HasLineDecorator() const
    {
        return decoratorWidth != 0.0f && decoratorCallback != nullptr;
    }

    // setup context menu callbacks (these are called when a user right clicks line numbers or
    // somewhere in the text) the editor sets up the popup menus, the callback has to populate them
    inline void SetLineNumberContextMenuCallback(std::function<void(int line)> callback)
    {
        lineNumberContextMenuCallback = callback;
    }
    inline void ClearLineNumberContextMenuCallback()
    {
        SetLineNumberContextMenuCallback(nullptr);
    }
    inline bool HasLineNumberContextMenuCallback() const
    {
        return lineNumberContextMenuCallback != nullptr;
    }

    inline void SetTextContextMenuCallback(std::function<void(int line, int column)> callback)
    {
        textContextMenuCallback = callback;
    }
    inline void ClearTextContextMenuCallback()
    {
        SetTextContextMenuCallback(nullptr);
    }
    inline bool HasTextContextMenuCallback() const
    {
        return textContextMenuCallback != nullptr;
    }

    // useful functions to work on selections
    // NOTE: functions provided to FilterSelections or FilterLines should accept and return UTF-8
    // encoded strings
    inline void IndentLines()
    {
        if (!readOnly)
        {
            indentLines();
    ...
    inline void ToggleComments()
    {
        if (!readOnly && language)
        {
            toggleComments();
        }
    }
    inline void FilterSelections(std::function<std::string(std::string_view)> filter)
    {
        if (!readOnly)
        {
    ...
    inline void SelectionToLowerCase()
    {
        if (!readOnly)
        {
    ...
    inline void SelectionToUpperCase()
    {
        if (!readOnly)
        {
    ...
    inline void StripTrailingWhitespaces()
    {
        if (!readOnly)
        {
    ...
    inline void FilterLines(std::function<std::string(std::string_view)> filter)
    {
        if (!readOnly)
        {
            filterLines(filter);
    ...
    {
    public:
        inline ImU32 get(Color color) const
        {
            return at(static_cast<size_t>(color));
        }
    };

    inline void SetPalette(const Palette &newPalette)
    {
        paletteBase  = newPalette;
        paletteAlpha = -1.0f;
    }
    ...
    static inline void SetDefaultPalette(const Palette &aValue)
    {
        defaultPalette = aValue;
    }
    static inline Palette &GetDefaultPalette()
    {
    ...
    public:
        ...
        inline size_t operator-(const Iterator &a)
        {
    ...
    public:
        ...
        // the character that starts a preprocessor directive (can be 0 if language doesn't have
        // this feature)
        ImWchar preprocess = 0;

        // a character sequence that start a single line comment (can be blank if language doesn't
        // have this feature)
        std::string singleLineComment;

        // an alternate single line comment character sequence (can be blank if language doesn't
        // have this feature)
        std::string singleLineCommentAlt;

        // the start and end character sequence for multiline comments (can be blank language
        // doesn't have this feature)
        std::string commentStart;
        std::string commentEnd;

        // flags specifying whether language supports single quoted ['] and/or double quoted [""]
        // strings
        bool hasSingleQuotedStrings = false;
        bool hasDoubleQuotedStrings = false;

        // other character sequences that start and end strings (can be blank if language doesn't
        // have this feature)
        std::string otherStringStart;
        std::string otherStringEnd;

        // alternate character sequences that start and end strings (can be blank if language
        // doesn't have this feature)
        std::string otherStringAltStart;
        std::string otherStringAltEnd;

        // character inside string used to escape the next character (can be 0 if language doesn't
        // have this feature)
        ImWchar stringEscape = 0;

        // set of keywords, declarations, identifiers used in the language (can be blank if language
        // doesn't have these features) if language is not case sensitive, all entries should be in
        // lower case
        ...
        // functions to tokenize identifiers and numbers (can be nullptr if language doesn't have
        // this feature) start and end refer to the characters being tokenized functions should
        // return an iterator to the character after the detected token returning start means no
        // token was found
        ...
        // if a token is found, function should return an iterator to the character after the token
        // and set the color
    ...
    inline void SetLanguage(const Language *l)
    {
        language        = l;
    ...
    inline std::string GetLanguageName() const
    {
        return language == nullptr ? "None" : language->name;
    }

    // iterate through identifiers detected by the colorizer (based on current language)
    inline void IterateIdentifiers(
        std::function<void(const std::string &identifier)> callback) const
    {
        document.iterateIdentifiers(callback);
    }
    ...
    {
    public:
        // current context (strings = UTF-8, columns = Nth visible column and indices = Nth
        // codepoint) to understand the difference between column and index, think like a tab :-)
        ...
        // auto complete suggestions te be provided by app callback (the app is responsible for
        // sorting)

        // the editor does not automatically include language specific keywords or identifiers in
        // the suggestion list this is left to the application so it can be context specific in case
        // a language server is used a pointer to the current language definition is provided so
        // callbacks have easy access
        std::vector<std::string> suggestions;

        // set this to true if you are building the suggestion list asynchronously and provide it
        // later this way autocomplete is not cancelled if the suggestion list is empty and the user
        // hits tab or enter
    ...
    public:
        ...
        // called when autocomplete is configured, active and the editor needs an updated
        // suggestions list callback must populate and order suggestions in state object suggestion
        // list is not cleared by editor between callbacks callback is called during the rendering
        // loop (so don't take too long)
    ...
    inline void SetAutoCompleteConfig(const AutoCompleteConfig *config)
    {
        autocomplete.setConfig(config);
    }

    // provide autocomplete suggestions asynchronously (in case a callback takes to long and lookup
    // is handled in a separate thread/process) this call is not threadsafe and must be called from
    // the rendering thread (you must synchronize with your lookup thread yourself)
    inline void SetAutoCompleteSuggestions(const std::vector<std::string> &suggestions)
    {
    ...
    public:
        ...
        // maxSkippedLetters is a the largest number of letters that can be skipped to find the next
        // match this allows for missing letters (out of order letters are not taken into account)
        void findSuggestions(std::vector<std::string> &suggestions,
                             const std::string_view   &searchTerm,
                             size_t                    limit             = 20,
                             size_t                    maxSkippedLetters = 2);
    ...
    private:
        ...
        struct Candidate
        {
            Candidate(const Node *n, size_t c)
                : node(n)
                , cost(c)
            {
            }
    ...
    {
    public:
        static std::string_view::const_iterator skipBOM(std::string_view::const_iterator i,
                                                        std::string_view::const_iterator end);
        static std::string_view::const_iterator read(std::string_view::const_iterator i,
                                                     std::string_view::const_iterator end,
                                                     ImWchar                         *codepoint);
        static size_t write(char *i, ImWchar codepoint); // must point to buffer of 4 characters
        ...
        {
            return ch == openCurlyBracket || ch == openSquareBracket || ch == openParenthesis
                   || ch == singleQuote || ch == doubleQuote;
        }

        static inline bool isPairCloser(ImWchar ch)
        {
            return ch == closeCurlyBracket || ch == closeSquareBracket || ch == closeParenthesis
                   || ch == singleQuote || ch == doubleQuote;
        }

        static inline ImWchar toPairCloser(ImWchar ch)
        {
            return (ch == openCurlyBracket)    ? closeCurlyBracket
        ...
        {
            return (ch == closeCurlyBracket)    ? openCurlyBracket
    ...
    static inline void SetImGuiContext(ImGuiContext *ctx)
    {
...
protected:
    ...
    class Coordinate
    {
        // represent a character coordinate from the user's point of view, i. e. consider an uniform
        // grid on the screen as it is rendered, and each cell has its own coordinate, starting from
        // 0
        //
        // tabs are counted as [1..tabsize] count spaces, depending on how many spaces are necessary
        // to reach the next tab stop
        //
        // for example, coordinate (1, 5) represents the character 'B' in a line "\tABC", when
        // tabsize = 4, because it is rendered as "    ABC" on the screen
    ...
    public:
        ...
        inline Coordinate operator-(const Coordinate &o) const
        {
            return Coordinate(line - o.line, column - o.column);
        }
        inline Coordinate operator+(const Coordinate &o) const
        {
            return Coordinate(line + o.line, column + o.column);
        ...
        static inline Coordinate invalid()
        {
    ...
    public:
        ...
        Cursor(Coordinate s, Coordinate e)
            : start(s)
            , end(e)
        {
        }
        ...
        // update the cursor
        inline void update(Coordinate coordinate)
        {
            end     = coordinate;
            updated = true;
        }
        inline void update(Coordinate s, Coordinate e)
        {
            start   = s;
            end     = e;
            updated = true;
        }
        inline void update(Coordinate coordinate, bool keep)
        {
            if (keep)
            {
                update(coordinate);
        ...
        inline Coordinate getInteractiveStart() const
        {
            return start;
        }
        inline Coordinate getInteractiveEnd() const
        {
            return end;
        }
        inline Coordinate getSelectionStart() const
        {
            return start < end ? start : end;
        }
        inline Coordinate getSelectionEnd() const
        {
            return start > end ? start : end;
        }
        ...
        {
            update(getSelectionStart(), getSelectionStart());
        }
        inline void resetToEnd()
        {
            update(getSelectionEnd(), getSelectionEnd());
        }
        ...
        inline void setCurrent(bool value)
        {
            current = value;
        }
        ...
        inline void setUpdated(bool value)
        {
            updated = value;
        }
    ...
    private:
        // helper functions
        Coordinate adjustCoordinateForInsert(Coordinate coordinate,
                                             Coordinate insertStart,
                                             Coordinate insertEnd);
        Coordinate adjustCoordinateForDelete(Coordinate coordinate,
    ...
    public:
        ...
        inline void setCursor(Coordinate coordinate)
        {
            setCursor(coordinate, coordinate);
        }
        void setCursor(Coordinate start, Coordinate end);

        // add a cursor to the list
        inline void addCursor(Coordinate c)
        {
            addCursor(c, c);
        }
        ...
        inline void updateCurrentCursor(Coordinate coordinate)
        {
            at(current).update(coordinate);
        }
        inline void updateCurrentCursor(Coordinate start, Coordinate end)
        {
            at(current).update(start, end);
        }
        inline void updateCurrentCursor(Coordinate coordinate, bool keep)
        {
            at(current).update(coordinate, keep);
        }

        // check cursor status
        inline bool hasMultiple() const
        {
            return size() > 1;
        }
        bool        anyHasSelection() const;
        bool        allHaveSelection() const;
        inline bool mainCursorHasSelection() const
        {
            return at(main).hasSelection();
        }
        inline bool currentCursorHasSelection() const
        {
            return at(current).hasSelection();
        }
        inline bool mainHasUpdate() const
        {
            return at(main).isUpdated();
        }
        ...
        inline Cursor &getMain()
        {
            return at(main);
        }
        inline size_t getMainIndex() const
        {
            return main;
        }
        inline Cursor &getCurrent()
        {
            return at(current);
        }
        ...
        inline iterator getMainAsIterator()
        {
            return begin() + main;
        }
        inline iterator getCurrentAsIterator()
        {
    ...
    public:
        ...
        inline void setInsertSpacesOnTabs(bool value)
        {
            insertSpacesOnTabs = value;
        }
        inline bool isInsertSpacesOnTabs() const
        {
            return insertSpacesOnTabs;
        }
        ...
        inline State getLineState(int line) const
        {
            return at(line).state;
        }
        ...
        inline int getColumn(int line, size_t index) const
        {
            return getColumn(at(line), index);
        }
        ...
        inline Coordinate getNextLine(Coordinate from) const
        {
            return getRight(getEndOfLine(from));
        }
        ...
        inline bool isEndOfLine(Coordinate from) const
        {
            return getIndex(from) == at(from.line).size();
        }
        inline bool isLastLine(int line) const
        {
        ...
        void       normalizeCoordinate(float       line,
                                       float       column,
    ...
    public:
        ...
        // constructors
        Action() = default;
        Action(Type t, Coordinate s, Coordinate e, const std::string_view &txt)
            : type(t)
            , start(s)
            , end(e)
            , text(txt)
    ...
    public:
        ...
        inline void setBeforeState(const Cursors &cursors)
        {
            before = cursors;
        }
        inline const Cursors &getBeforeState() const
        {
            return before;
        }
        inline void setAfterState(const Cursors &cursors)
        {
            after = cursors;
        }
        inline const Cursors &getAfterState() const
        {
            return after;
        }

        // add actions by type
        void addInsert(Coordinate start, Coordinate end, std::string_view text)
        {
            emplace_back(Action::Type::insertText, start, end, text);
        };
        void addDelete(Coordinate start, Coordinate end, std::string_view text)
        {
            emplace_back(Action::Type::deleteText, start, end, text);
        };

        // get number of actions
        inline int actions() const
        {
            return static_cast<int>(size());
        }
    ...
    public:
        ...
        static inline std::shared_ptr<Transaction> create()
        {
        ...
        inline bool canRedo() const
        {
            return undoIndex < size();
        }
        inline size_t getVersion() const
        {
            return version;
        }
    ...
    private:
        ...
        inline void setColor(Line::iterator start, Line::iterator end, Color color)
        {
            while (start < end)
            {
                (start++)->color = color;
    ...
    {
    public:
        BracketPair(ImWchar sc, Coordinate s, ImWchar ec, Coordinate e, int l)
            : startChar(sc)
            , start(s)
            , endChar(ec)
            , end(e)
        ...
        inline bool isAfter(Coordinate location) const
        {
            return start > location;
        }
        inline bool isAround(Coordinate location) const
        {
    ...
    public:
        ...
        {
            return glyph.color == Color::punctuation || glyph.color == Color::matchingBracketLevel1
    ...
    public:
        ...
        inline bool hasSuggestions() const
        {
            return state.suggestions.size() > 0 || state.suggestionsPromise;
        }
        bool                 isSpecialKeyPressed() const;
        inline ImGuiKeyChord getTriggerShortcut() const
        {
            return configuration.triggerShortcut;
        }
        inline Coordinate getStart() const
        {
    ...
    void replaceSectionText(const Coordinate       &start,
    ...
    void       insertTextIntoAllCursors(std::shared_ptr<Transaction> transaction,
                                        const std::string_view      &text);
    ...
    Coordinate insertText(std::shared_ptr<Transaction> transaction,
                          Coordinate                   start,
                          const std::string_view      &text);
