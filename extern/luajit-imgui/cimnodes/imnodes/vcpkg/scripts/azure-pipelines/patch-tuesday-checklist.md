...
* [ ] Update the managed image for compiler testing and delete unused images.
    ...
    * Standard HDD LRS
        ...
        * West US 2, 1 Replica
        * West US 3, 1 Replica
* [ ] After the last build finishes on the previous pool, delete it in the Azure Devops *Organization* UI and its
  Resource Group. ( https://dev.azure.com/vcpkg/_settings/agentpools ?)
