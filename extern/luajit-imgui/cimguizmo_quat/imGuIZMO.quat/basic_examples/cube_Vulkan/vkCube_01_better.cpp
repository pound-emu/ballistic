...
vkApp::run()
{
    ...
    { // glfwPollEvents | SDL_PollEvent + ImGui_ImplSDL2/3_ProcessEvent ... and exit check
        ...
        static quat rotation(
            1, 0, 0, 0); // vgMath quat: default constructor initialize @ w(1) x(0) y(0) z(0) ==> w
                         // is left/first value for GLM compatibility (if you want switch in future)
                         // is necessary an explicit initialization
        ...
        uboMat.mvpMatrix
            = clipMatrix * projMatrix * viewMatrix
              * static_cast<mat4>(rotation); // or use a cast: watch vgMath for all overload
                                             // operators: quat ==> mat4 / mat3
