...
vkApp::setScene()
{
    ...
    /// imGuIZMO / vGizmo3D
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    // track.setRotation(quat(1,0,0,0));                     // vGizmo3D with NO initial rotation
    // (default initialization) track.setRotation(eulerAngleXYZ(vec3(radians(45),
    //                                     radians( 0),
...
vkApp::run()
{
    ...
    { // glfwPollEvents | SDL_PollEvent ... with exit/quit check
        ...
        ImGui::TextColored(ImVec4(1, 1, 1, 1), "w: % 1.2f", vgTrackball.getRotation().w);
        ImGui::SameLine();
        ImGui::TextColored(ImVec4(1, 0, 0, 1), "x: % 1.2f", vgTrackball.getRotation().x);
        ImGui::SameLine();
        ImGui::TextColored(ImVec4(0, 1, 0, 1), "y: % 1.2f", vgTrackball.getRotation().y);
        ImGui::SameLine();
        ...
        //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        ImGui::gizmo3D("##a01",
                       vgTrackball.refPosition(),
                       vgTrackball.refRotation(),
                       widgetSize); // Ctrl+LButton = Pan ... Shift+LButton = Dolly/Zoom
