...
draw()
{
    ...
    glProgramUniformMatrix4fv(program,
                              ...
                              1,
                              false,
                              value_ptr(mvpMatrix)); // internal vgMath permits also "static_cast":
                                                     // use value_ptr for GLM compatibility
...
main(int /* argc */, char ** /* argv */) // necessary for SDLmain in Windows
{
    ...
    while (!glfwWindowShouldClose(glfwWindow))
    {
        ...
        //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        static quat rotation(1, 0, 0, 0); // quat constructor initialize @ quat(1,0,0,0) ==> w(1)
                                          // x(0) y(0) z(0), w is left/first value
        ...
        // build MVP matrix to pass to shader ==> view oglCube_05 and higher for better
