...
draw()
{
    ...
    glDrawArraysInstanced(
        GL_TRIANGLES, 0, nVertex, 2); // now using instanced draw to "simulate" lightPos
...
main(int /* argc */, char ** /* argv */) // necessary for SDLmain in Windows
{
    ...
    while (!glfwWindowShouldClose(glfwWindow))
    {
        ...
        //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        static quat rotation(1, 0, 0, 0); // quat default constructor initialize @ quat(1,0,0,0) ==>
                                          // w(1) x(0) y(0) z(0), w is left/first value
        ...
        // build MVP matrix to pass to shader  ==> watch oglCube_05 and higher for better / more
        // correct implementation
        mvpMatrix   = projMatrix * viewMatrix * translationMatrix * modelMatrix;
        lightMatrix = projMatrix * translationMatrix * translate(mat4(1), lightPos) * viewMatrix
