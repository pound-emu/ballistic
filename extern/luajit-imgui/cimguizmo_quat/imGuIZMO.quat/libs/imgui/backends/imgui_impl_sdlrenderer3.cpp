...
//  2024-10-09: Expose selected render state in ImGui_ImplSDLRenderer3_RenderState, which you can
//  access in 'void* platform_io.Renderer_RenderState' during draw callbacks. 2024-07-01: Update for
//  SDL3 api changes: SDL_RenderGeometryRaw() uint32 version was removed (SDL#9009). 2024-05-14:
//  *BREAKING CHANGE* ImGui_ImplSDLRenderer3_RenderDrawData() requires SDL_Renderer* passed as
//  parameter. 2024-02-12: Amend to query SDL_RenderViewportSet() and restore viewport accordingly.
...
static void
ImGui_ImplSDLRenderer3_SetupRenderState(SDL_Renderer *renderer)
{
...
static int
SDL_RenderGeometryRaw8BitColor(SDL_Renderer         *renderer,
...
void
ImGui_ImplSDLRenderer3_RenderDrawData(ImDrawData *draw_data, SDL_Renderer *renderer)
{
    ImGui_ImplSDLRenderer3_Data *bd = ImGui_ImplSDLRenderer3_GetBackendData();
...
ImGui_ImplSDLRenderer3_CreateFontsTexture()
{
    ...
    bd->FontTexture = SDL_CreateTexture(
        bd->Renderer, SDL_PIXELFORMAT_RGBA32, SDL_TEXTUREACCESS_STATIC, width, height);
