...
//  2024-10-09: Expose selected render state in ImGui_ImplSDLRenderer2_RenderState, which you can
//  access in 'void* platform_io.Renderer_RenderState' during draw callbacks. 2024-05-14: *BREAKING
//  CHANGE* ImGui_ImplSDLRenderer3_RenderDrawData() requires SDL_Renderer* passed as parameter.
//  2023-05-30: Renamed imgui_impl_sdlrenderer.h/.cpp to imgui_impl_sdlrenderer2.h/.cpp to
//  accommodate for upcoming SDL3. 2022-10-11: Using 'nullptr' instead of 'NULL' as per our switch
//  to C++11. 2021-12-21: Update SDL_RenderGeometryRaw() format to work with SDL 2.0.19. 2021-12-03:
//  Added support for large mesh (64K+ vertices), enable ImGuiBackendFlags_RendererHasVtxOffset
//  flag. 2021-10-06: Backup and restore modified ClipRect/Viewport. 2021-09-21: Initial version.
...
static void
ImGui_ImplSDLRenderer2_SetupRenderState(SDL_Renderer *renderer)
{
