...
//  [X] Renderer: User texture binding. Use 'ID3D10ShaderResourceView*' as ImTextureID. Read the FAQ
...
//  2025-01-06: DirectX10: Expose selected render state in ImGui_ImplDX10_RenderState, which you can
//  access in 'void* platform_io.Renderer_RenderState' during draw callbacks. 2024-10-07: DirectX10:
//  Changed default texture sampler to Clamp instead of Repeat/Wrap. 2022-10-11: Using 'nullptr'
//  instead of 'NULL' as per our switch to C++11. 2021-06-29: Reorganized backend to pull data from
//  a single structure to facilitate usage with multiple-contexts (all g_XXXX access changed to
//  bd->XXXX). 2021-05-19: DirectX10: Replaced direct access to ImDrawCmd::TextureId with a call to
//  ImDrawCmd::GetTexID(). (will become a requirement) 2021-02-18: DirectX10: Change blending
//  equation to preserve alpha in output buffer. 2019-07-21: DirectX10: Backup, clear and restore
//  Geometry Shader is any is bound when calling ImGui_ImplDX10_RenderDrawData(). 2019-05-29:
//  DirectX10: Added support for large mesh (64K+ vertices), enable
...
// Functions
static void
ImGui_ImplDX10_SetupRenderState(ImDrawData *draw_data, ID3D10Device *device)
{
...
ImGui_ImplDX10_CreateDeviceObjects()
{
    ...
    // DX10 sample code but remove this dependency you can:
