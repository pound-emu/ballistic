...
// Usage:
// - Add '#define IMGUI_ENABLE_FREETYPE' in your imconfig to enable support for imgui_freetype in
// imgui.
...
// atlas->FontBuilderIO = GetBuilderForFreeType(); atlas->FontBuilderFlags = flags; return
