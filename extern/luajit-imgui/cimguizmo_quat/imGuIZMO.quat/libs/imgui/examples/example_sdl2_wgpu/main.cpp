...
static WGPUTextureFormat wgpu_preferred_fmt
...
static WGPUTexture
check_surface_texture_status(SDL_Window *window)
{
...
main(int, char **)
{
    ...
    SDL_SetHint(SDL_HINT_VIDEODRIVER,
                "x11"); // export SDL_VIDEODRIVER=wayland             (to set wayland session type)
    ...
    SDL_Window *window = SDL_CreateWindow("Dear ImGui SDL+WebGPU example",
...
void
ResizeSurface(int width, int height)
{
