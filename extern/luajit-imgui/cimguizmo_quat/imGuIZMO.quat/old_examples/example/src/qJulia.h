...
public:
    vaoClass()
    {
        float vtx[] = { -1.0f, -1.0f, 1.0f, -1.0f, 1.0f, 1.0f, -1.0f, 1.0f };
...
public:
    ...
    GLuint _Resolution, _quatPt, _diffuseColor, _phongMethod, _specularExponent, _specularComponent,
        _normalComponent, _isFullRender, _useShadow, _useAO, _matOrientation, _Light, _position,
        _epsilon;
};