...
public:
    ...
    explicit Vec3(T s, const VEC2_T &v)
        : x(s)
        , y(v.x)
        , z(v.y)
    {
    }
    explicit Vec3(const VEC2_T &v, T s)
        : x(v.x)
        , y(v.y)
        , z(s)
    {
...
public:
    ...
    explicit Vec4(const VEC3_T &v, T s)
        : x(v.x)
        , y(v.y)
        , z(v.z)
        , w(s)
    ...
    explicit Vec4(T s, const VEC3_T &v)
        : x(s)
        , y(v.x)
        , z(v.y)
        , w(v.z)
...
public:
    ...
    explicit Quat(T s, const VEC3_T &v)
        : x(v.x)
        , y(v.y)
        , z(v.z)
        , w(s)
...
public:
    ...
    explicit Mat3(T s)
        : v { VEC3_T(s, 0, 0), VEC3_T(0, s, 0), VEC3_T(0, 0, s) }
    {
    }
...
#define M(X, Y) (m##X * m.m##Y)
    Mat3 operator*(const Mat3 &m) const
    {
        return { M(00, 00) + M(10, 01) + M(20, 02), M(01, 00) + M(11, 01) + M(21, 02),
                 M(02, 00) + M(12, 01) + M(22, 02), M(00, 10) + M(10, 11) + M(20, 12),
                 M(01, 10) + M(11, 11) + M(21, 12), M(02, 10) + M(12, 11) + M(22, 12),
                 M(00, 20) + M(10, 21) + M(20, 22), M(01, 20) + M(11, 21) + M(21, 22),
...
public:
    ...
    Mat4() = default;
    explicit Mat4(T s)
        : v { VEC4_T(s, 0, 0, 0), VEC4_T(0, s, 0, 0), VEC4_T(0, 0, s, 0), VEC4_T(0, 0, 0, s) }
    {
    }
    ...
    Mat4(const MAT3_T &m)
        : v { VEC4_T(m.v[0], 0), VEC4_T(m.v[1], 0), VEC4_T(m.v[2], 0), VEC4_T(0, 0, 0, 1) }
    {
    }
    Mat4(T v0x,
         T v0y,
...
// cast / conversion
//////////////////////////
TEMPLATE_TYPENAME_T inline VEC2_T::Vec2(const VEC3_T &v)
    : VEC2_T { v.x, v.y }
{
}
TEMPLATE_TYPENAME_T inline VEC3_T::Vec3(const VEC4_T &v)
    : VEC3_T { v.x, v.y, v.z }
{
}
TEMPLATE_TYPENAME_T inline MAT3_T::Mat3(const MAT4_T &m)
    : v { VEC3_T(m.v[0]), m.v[1], m.v[2] }
{
}
...
TEMPLATE_TYPENAME_T inline MAT4_T::Mat4(QUAT_T const &q)
{
    *this = MAT4_T(MAT3_T(q));
}
TEMPLATE_TYPENAME_T inline MAT3_T
mat3_cast(QUAT_T const &q)
{
    return MAT3_T(q);
}
TEMPLATE_TYPENAME_T inline MAT4_T
mat4_cast(QUAT_T const &q)
{
    return MAT3_T(q);
}
TEMPLATE_TYPENAME_T inline VEC3_T
getTranslationVec(const MAT4_T &m)
{
    return { m.v[3] };
}

inline float
uintBitsToFloat(uint32_t const v)
{
    return *((float *)(&v));
}
inline uint32_t
floatBitsToUint(float const v)
{
    return *((uint32_t *)(&v));
}
// dot
//////////////////////////
TEMPLATE_TYPENAME_T inline T
dot(const VEC2_T &v0, const VEC2_T &v1)
{
    return v0.x * v1.x + v0.y * v1.y;
}
TEMPLATE_TYPENAME_T inline T
dot(const VEC3_T &v0, const VEC3_T &v1)
{
    return v0.x * v1.x + v0.y * v1.y + v0.z * v1.z;
}
TEMPLATE_TYPENAME_T inline T
dot(const VEC4_T &v0, const VEC4_T &v1)
{
    return v0.x * v1.x + v0.y * v1.y + v0.z * v1.z + v0.w * v1.w;
}
TEMPLATE_TYPENAME_T inline T
dot(const QUAT_T &q0, const QUAT_T &q1)
{
...
//////////////////////////
TEMPLATE_TYPENAME_T inline T
cross(const VEC2_T &u, const VEC2_T &v)
{
    return u.x * v.y - v.x * u.y;
}
TEMPLATE_TYPENAME_T inline VEC3_T
cross(const VEC3_T &u, const VEC3_T &v)
{
...
//////////////////////////
TEMPLATE_TYPENAME_T inline T
length(const VEC2_T &v)
{
    return sqrt(dot(v, v));
}
TEMPLATE_TYPENAME_T inline T
length(const VEC3_T &v)
{
    return sqrt(dot(v, v));
}
TEMPLATE_TYPENAME_T inline T
length(const VEC4_T &v)
{
    return sqrt(dot(v, v));
}
TEMPLATE_TYPENAME_T inline T
length(const QUAT_T &q)
{
    return sqrt(dot(q, q));
}
// distance
//////////////////////////
TEMPLATE_TYPENAME_T inline T
distance(const VEC2_T &v0, const VEC2_T &v1)
{
    return length(v1 - v0);
}
TEMPLATE_TYPENAME_T inline T
distance(const VEC3_T &v0, const VEC3_T &v1)
{
    return length(v1 - v0);
}
TEMPLATE_TYPENAME_T inline T
distance(const VEC4_T &v0, const VEC4_T &v1)
{
    return length(v1 - v0);
}
// abs
...
TEMPLATE_TYPENAME_T inline VEC2_T
abs(const VEC2_T &v)
{
...
TEMPLATE_TYPENAME_T inline VEC4_T
abs(const VEC4_T &v)
{
    return { tAbs(v.x), tAbs(v.y), tAbs(v.z), tAbs(v.w) };
}
TEMPLATE_TYPENAME_T inline QUAT_T
abs(const QUAT_T &q)
{
...
//////////////////////////
TEMPLATE_TYPENAME_T inline VEC2_T
normalize(const VEC2_T &v)
{
    return v / length(v);
}
TEMPLATE_TYPENAME_T inline VEC3_T
normalize(const VEC3_T &v)
{
    return v / length(v);
}
TEMPLATE_TYPENAME_T inline VEC4_T
normalize(const VEC4_T &v)
{
    return v / length(v);
}
TEMPLATE_TYPENAME_T inline QUAT_T
normalize(const QUAT_T &q)
{
    return q / length(q);
}
TEMPLATE_TYPENAME_T inline MAT3_T
normalize(const MAT3_T &m)
{
    return m / sqrt(dot(m.v[0], m.v[0]) + dot(m.v[1], m.v[1]) + dot(m.v[2], m.v[2]));
}
TEMPLATE_TYPENAME_T inline MAT3_T
normalize(const MAT4_T &m)
{
    return m
           / sqrt(dot(m.v[0], m.v[0]) + dot(m.v[1], m.v[1]) + dot(m.v[2], m.v[2])
                  + dot(m.v[3], m.v[3]));
}
// mix
//////////////////////////
TEMPLATE_TYPENAME_T inline T
mix(const T x, const T y, const T a)
{
    return x + (y - x) * a;
}
TEMPLATE_TYPENAME_T inline VEC2_T
mix(const VEC2_T &x, const VEC2_T &y, const T a)
{
    return x + (y - x) * a;
}
TEMPLATE_TYPENAME_T inline VEC3_T
mix(const VEC3_T &x, const VEC3_T &y, const T a)
{
    return x + (y - x) * a;
}
TEMPLATE_TYPENAME_T inline VEC4_T
mix(const VEC4_T &x, const VEC4_T &y, const T a)
{
    return x + (y - x) * a;
}
// pow
//////////////////////////
TEMPLATE_TYPENAME_T inline VEC2_T
pow(const VEC2_T &b, const VEC2_T &e)
{
    return { std::pow(b.x, e.x), std::pow(b.y, e.y) };
}
TEMPLATE_TYPENAME_T inline VEC3_T
pow(const VEC3_T &b, const VEC3_T &e)
{
    return { std::pow(b.x, e.x), std::pow(b.y, e.y), std::pow(b.z, e.z) };
}
TEMPLATE_TYPENAME_T inline VEC4_T
pow(const VEC4_T &b, const VEC4_T &e)
{
    return { std::pow(b.x, e.x), std::pow(b.y, e.y), std::pow(b.z, e.z), std::pow(b.w, e.w) };
}
// value_ptr
//////////////////////////
TEMPLATE_TYPENAME_T inline T *
value_ptr(const VEC2_T &v)
{
    return const_cast<T *>(&v.x);
}
TEMPLATE_TYPENAME_T inline T *
value_ptr(const VEC3_T &v)
{
    return const_cast<T *>(&v.x);
}
TEMPLATE_TYPENAME_T inline T *
value_ptr(const VEC4_T &v)
{
    return const_cast<T *>(&v.x);
}
TEMPLATE_TYPENAME_T inline T *
value_ptr(const QUAT_T &q)
{
    return const_cast<T *>(&q.x);
}
TEMPLATE_TYPENAME_T inline T *
value_ptr(const MAT3_T &m)
{
    return const_cast<T *>(&m.m00);
}
TEMPLATE_TYPENAME_T inline T *
value_ptr(const MAT4_T &m)
{
    return const_cast<T *>(&m.m00);
}

TEMPLATE_TYPENAME_T inline QUAT_T::Quat(const MAT3_T &m)
{ // experimental implementation: personal optimization, not full tested but well documented
    T val; // credits:
    ...
    if (m.m22 < 0)
    {
        if (m.m00 > m.m11)
        {
            val   = T(1) + m.m00 - m.m11 - m.m22,
            *this = getSqrt(QUAT_T(m.m12 - m.m21, val, m.m01 + m.m10, m.m20 + m.m02));
        }
        else
        {
            val   = T(1) - m.m00 + m.m11 - m.m22,
            *this = getSqrt(QUAT_T(m.m20 - m.m02, m.m01 + m.m10, val, m.m12 + m.m21));
        }
    }
    else
    {
        ...
        {
            val   = T(1) - m.m00 - m.m11 + m.m22,
            *this = getSqrt(QUAT_T(m.m01 - m.m10, m.m20 + m.m02, m.m12 + m.m21, val));
        }
        else
        {
            val   = T(1) + m.m00 + m.m11 + m.m22,
            *this = getSqrt(QUAT_T(val, m.m12 - m.m21, m.m20 - m.m02, m.m01 - m.m10));
        }
    }
}
TEMPLATE_TYPENAME_T inline QUAT_T::Quat(const MAT4_T &m)
{
    *this = QUAT_T((const MAT3_T &)m);
}
TEMPLATE_TYPENAME_T inline QUAT_T
quat_cast(const MAT3_T &m)
{
    return QUAT_T(m);
}
...
TEMPLATE_TYPENAME_T inline QUAT_T
inverse(QUAT_T const &q)
{
    return QUAT_T(q.w, -q.x, -q.y, -q.z) / dot(q, q);
}
TEMPLATE_TYPENAME_T inline MAT3_T
inverse(MAT3_T const &m)
{
    T invDet = T(1)
               / (m.m00 * (M(11, 22) - M(21, 12)) - m.m10 * (M(01, 22) - M(21, 02))
                  + m.m20 * (M(01, 12) - M(11, 02)));
    return MAT3_T((M(11, 22) - M(21, 12)),
                  -(M(01, 22) - M(21, 02)),
                  (M(01, 12) - M(11, 02)),
                  -(M(10, 22) - M(20, 12)),
                  (M(00, 22) - M(20, 02)),
...
//////////////////////////
TEMPLATE_TYPENAME_T inline VEC2_T
operator*(const T s, const VEC2_T &v)
{
    return v * s;
}
TEMPLATE_TYPENAME_T inline VEC3_T
operator*(const T s, const VEC3_T &v)
{
    return v * s;
}
TEMPLATE_TYPENAME_T inline VEC4_T
operator*(const T s, const VEC4_T &v)
{
    return v * s;
}
TEMPLATE_TYPENAME_T inline QUAT_T
operator*(const T s, const QUAT_T &q)
{
    return q * s;
}
...
TEMPLATE_TYPENAME_T inline VEC3_T
operator*(const QUAT_T &q, const VEC3_T &v)
{
    const VEC3_T qV(q.x, q.y, q.z), uv(cross(qV, v));
    return v + ((uv * q.w) + cross(qV, uv)) * T(2);
}
TEMPLATE_TYPENAME_T inline VEC3_T
operator*(const VEC3_T &v, const QUAT_T &q)
{
    return inverse(q) * v;
}
...
//////////////////////////
TEMPLATE_TYPENAME_T inline MAT4_T
translate(MAT4_T const &m, VEC3_T const &v)
{
    MAT4_T r(m);
...
TEMPLATE_TYPENAME_T inline MAT4_T
scale(MAT4_T const &m, VEC3_T const &v)
{
    return MAT4_T(m[0] * v[0], m[1] * v[1], m[2] * v[2], m[3]);
}

TEMPLATE_TYPENAME_T inline MAT4_T
rotate(MAT4_T const &m, const T a, VEC3_T const &v)
{
...
//////////////////////////
TEMPLATE_TYPENAME_T inline QUAT_T
angleAxis(T const &a, VEC3_T const &v)
{
    return QUAT_T(cos(a * T(0.5)), v * sin(a * T(0.5)));
}
TEMPLATE_TYPENAME_T inline T
angle(QUAT_T const &q)
{
    return acos(q.w) * T(2);
}
TEMPLATE_TYPENAME_T inline VEC3_T
...
TEMPLATE_TYPENAME_T inline MAT4_T
eulerAngleXYZ(T const &t1, T const &t2, T const &t3)
{
...
TEMPLATE_TYPENAME_T inline MAT4_T
eulerAngleXYZ(VEC3_T const &v)
{
    return eulerAngleXYZ(v.x, v.y, v.z);
}
...
//////////////////////////
TEMPLATE_TYPENAME_T inline MAT4_T
lookAtLH(const VEC3_T &pov, const VEC3_T &tgt, const VEC3_T &up)
{
    VEC3_T k = normalize(tgt - pov), i = normalize(cross(up, k)), j = cross(k, i);
    return { i.x, j.x, k.x, T(0), i.y,          j.y,          k.y,          T(0),
             i.z, j.z, k.z, T(0), -dot(i, pov), -dot(j, pov), -dot(k, pov), T(1) };
}

TEMPLATE_TYPENAME_T inline MAT4_T
lookAtRH(const VEC3_T &pov, const VEC3_T &tgt, const VEC3_T &up)
{
...
TEMPLATE_TYPENAME_T inline MAT4_T
lookAt(const VEC3_T &pov, const VEC3_T &tgt, const VEC3_T &up)
{
...
//////////////////////////
TEMPLATE_TYPENAME_T inline MAT4_T
ortho_call(cT l, cT r, cT b, cT t, cT n, cT f, cT K, cT f_n)
{
...
TEMPLATE_TYPENAME_T inline MAT4_T
orthoLH_NO(cT l, cT r, cT b, cT t, cT n, cT f)
{
    return ortho_call(l, r, b, t, n, f, T(2), -(f + n) / (f - n));
}
TEMPLATE_TYPENAME_T inline MAT4_T
orthoLH_ZO(cT l, cT r, cT b, cT t, cT n, cT f)
{
    return ortho_call(l, r, b, t, n, f, T(1), -n / (f - n));
}
TEMPLATE_TYPENAME_T inline MAT4_T
orthoRH_NO(cT l, cT r, cT b, cT t, cT n, cT f)
{
    return ortho_call(l, r, b, t, n, f, -T(2), -(f + n) / (f - n));
}
TEMPLATE_TYPENAME_T inline MAT4_T
orthoRH_ZO(cT l, cT r, cT b, cT t, cT n, cT f)
{
    return ortho_call(l, r, b, t, n, f, -T(1), -n / (f - n));
}
TEMPLATE_TYPENAME_T inline MAT4_T
ortho(cT l, cT r, cT b, cT t, cT n, cT f)
{
#ifdef VGM_USES_LEFT_HAND_AXES
...
//////////////////////////
TEMPLATE_TYPENAME_T inline MAT4_T
perspective_call(cT fov, cT a, cT K, cT f_n, cT fn_fMn)
{
...
TEMPLATE_TYPENAME_T inline MAT4_T
perspectiveLH_ZO(cT fov, cT a, cT n, cT f)
{
    return perspective_call(fov, a, T(1), f / (f - n), -(f * n) / (f - n));
}
TEMPLATE_TYPENAME_T inline MAT4_T
perspectiveLH_NO(cT fov, cT a, cT n, cT f)
{
    return perspective_call(fov, a, T(1), (f + n) / (f - n), -(T(2) * f * n) / (f - n));
}
TEMPLATE_TYPENAME_T inline MAT4_T
perspectiveRH_ZO(cT fov, cT a, cT n, cT f)
{
    return perspective_call(fov, a, -T(1), f / (n - f), -(f * n) / (f - n));
}
TEMPLATE_TYPENAME_T inline MAT4_T
perspectiveRH_NO(cT fov, cT a, cT n, cT f)
{
    return perspective_call(fov, a, -T(1), -(f + n) / (f - n), -(T(2) * f * n) / (f - n));
}
TEMPLATE_TYPENAME_T inline MAT4_T
perspective(cT fov, cT a, cT n, cT f)
{
#ifdef VGM_USES_LEFT_HAND_AXES
#ifdef VGM_USES_ZERO_ONE_ZBUFFER
...
//////////////////////////
TEMPLATE_TYPENAME_T inline MAT4_T
perspectiveFov(cT fov, cT w, cT h, cT n, cT f)
{
...
//////////////////////////
TEMPLATE_TYPENAME_T inline MAT4_T
frustum_call(cT l, cT r, cT b, cT t, cT n, cT K, cT f_n, cT fn_fMn)
{
    return { (T(2) * n) / (r - l),
             T(0),
             T(0),
...
TEMPLATE_TYPENAME_T inline MAT4_T
frustumLH_ZO(cT l, cT r, cT b, cT t, cT n, cT f)
{
    return frustum_call(l, r, b, t, n, T(1), f / (f - n), -(f * n) / (f - n));
}
TEMPLATE_TYPENAME_T inline MAT4_T
frustumLH_NO(cT l, cT r, cT b, cT t, cT n, cT f)
{
    return frustum_call(l, r, b, t, n, T(1), (f + n) / (f - n), -(T(2) * f * n) / (f - n));
}
TEMPLATE_TYPENAME_T inline MAT4_T
frustumRH_ZO(cT l, cT r, cT b, cT t, cT n, cT f)
{
    return frustum_call(l, r, b, t, n, -T(1), f / (n - f), -(f * n) / (f - n));
}
TEMPLATE_TYPENAME_T inline MAT4_T
frustumRH_NO(cT l, cT r, cT b, cT t, cT n, cT f)
{
    return frustum_call(l, r, b, t, n, -T(1), -(f + n) / (f - n), -(T(2) * f * n) / (f - n));
}
TEMPLATE_TYPENAME_T inline MAT4_T
frustum(cT l, cT r, cT b, cT t, cT n, cT f)
{
#ifdef VGM_USES_LEFT_HAND_AXES
#ifdef VGM_USES_ZERO_ONE_ZBUFFER
