local cimguimodule = '/home/apollo/dev/ballistic/build/debug/lib/linux/libcimgui_glfw.so' --set imgui directory location
...
function CursorPosition.__new(ctype, a1, a2)
    -- generic version
    if a1 == nil then
        return CursorPosition.CursorPosition_Nil()
    end
    if (ffi.istype('int32_t', a1) or type(a1) == 'number') then
        return CursorPosition.CursorPosition_Int(a1, a2)
    end
    print(ctype, a1, a2)
...
function CursorSelection.__new(ctype, a1, a2)
    -- generic version
    if a1 == nil then
        return CursorSelection.CursorSelection_Nil()
    end
    if ffi.istype('CursorPosition', a1) then
        return CursorSelection.CursorSelection_CursorPosition(a1, a2)
    end
    print(ctype, a1, a2)
...
function Glyph.__new(ctype, a1, a2)
    -- generic version
    if a1 == nil then
...
function ImColor.__new(ctype, a1, a2, a3, a4)
    -- generic version
    if a1 == nil then
...
function ImDrawList:AddText(a2, a3, a4, a5, a6, a7, a8, a9)
    -- generic version
...
function ImGuiPtrOrIndex.__new(ctype, a1)
    -- generic version
...
function ImGuiStoragePair.__new(ctype, a1, a2)
    -- generic version
...
function ImGuiStyleMod.__new(ctype, a1, a2)
    -- generic version
    if (ffi.istype('int32_t', a2) or type(a2) == 'number') then
...
function ImGuiTextRange.__new(ctype, a1, a2)
    -- generic version
    if a1 == nil then
...
function ImGuiWindow:GetID(a2, a3)
    -- generic version
...
function ImPlot3DBox.__new(ctype, a1, a2)
    -- generic version
    if a1 == nil then
...
function ImPlot3DPoint.__new(ctype, a1, a2, a3)
    -- generic version
    if a1 == nil then
...
function ImPlot3DQuat.__new(ctype, a1, a2, a3, a4)
    -- generic version
    if a1 == nil then
...
function ImPlot3DRange.__new(ctype, a1, a2)
    -- generic version
    if a1 == nil then
...
function ImPlot3DSpec:SetProp(a2, a3)
    -- generic version
    ...
    if ffi.istype('ImS64', a3) then
        return self:SetProp_S64(a2, a3)
    end
    if ffi.istype('ImU64', a3) then
        return self:SetProp_U64(a2, a3)
    end
    if ffi.typeof('uint32_t*') == ffi.typeof(a3) or ffi.typeof('const uint32_t*') == ffi.typeof(a3) or ffi.typeof('uint32_t[?]') == ffi.typeof(a3) or ffi.typeof('const uint32_t[?]') == ffi.typeof(a3) then
...
function ImPlot3DStyle.__new(ctype, a1)
    -- generic version
    if a1 == nil then
...
function ImPlotAxis:SetRange(a2, a3)
    -- generic version
...
function ImPlotDateTimeSpec.__new(ctype, a1, a2, a3, a4)
    -- generic version
    if a1 == nil then
...
function ImPlotItemGroup:GetItem(a2)
    -- generic version
...
function ImPlotPoint.__new(ctype, a1, a2)
    -- generic version
    if a1 == nil then
...
function ImPlotPointError.__new(ctype, a1, a2, a3, a4)
    -- generic version
    if a1 == nil then
...
function ImPlotRange.__new(ctype, a1, a2)
    -- generic version
    if a1 == nil then
...
function ImPlotRect:Clamp(a2, a3)
    -- generic version
...
function ImPlotRect:Contains(a2, a3)
    -- generic version
    if ffi.istype('const ImPlotPoint', a2) then
...
function ImPlotRect.__new(ctype, a1, a2, a3, a4)
    -- generic version
    if a1 == nil then
...
function ImPlotSpec:SetProp(a2, a3)
    -- generic version
    if (ffi.istype('float', a3) or type(a3) == 'number') then
        return self:SetProp_Float(a2, a3)
    end
...
function ImPlotTick.__new(ctype, a1, a2, a3, a4)
    -- generic version
    if a1 == nil then
...
function ImPlotTicker:AddTick(a2, a3, a4, a5, a6, a7)
    -- generic version
    if (ffi.istype('double', a2) or type(a2) == 'number') and (ffi.istype('const char*', a6) or ffi.istype('char[]', a6) or type(a6) == 'string') then
...
function ImPlotTicker:GetText(a2)
    -- generic version
    if (ffi.istype('int32_t', a2) or type(a2) == 'number') then
...
function ImPlotTime.__new(ctype, a1, a2)
    -- generic version
    if a1 == nil then
...
function ImRect.__new(ctype, a1, a2, a3, a4)
    -- generic version
    if a1 == nil then
...
function ImTextureRef.__new(ctype, a1)
    ...
    if ffi.istype('ImTextureID', a1) then
...
function ImVec1.__new(ctype, a1)
    -- generic version
    if a1 == nil then
...
function ImVec2i.__new(ctype, a1, a2)
    -- generic version
    if a1 == nil then
...
function ImVec2ih.__new(ctype, a1, a2)
    -- generic version
    if a1 == nil then
...
--------------------------Iterator----------------------------
function M.Iterator_Iterator(a1)
    -- generic version
    if a1 == nil then
        return M.Iterator_Iterator_Nil()
    end
    if (ffi.istype('Glyph*', a1) or ffi.istype('Glyph', a1) or ffi.istype('Glyph[]', a1)) then
        return M.Iterator_Iterator_GlyphPtr(a1)
    end
    print(a1)
...
function TextEditor:GetCursor(a2, a3, a4, a5, a6)
    -- generic version
    if (ffi.istype('uint64_t', a4) or type(a4) == 'number') then
        return self:GetCursor_size_t(a2, a3, a4)
    end
    if ffi.typeof('int32_t*') == ffi.typeof(a4) or ffi.typeof('const int32_t*') == ffi.typeof(a4) or ffi.typeof('int32_t[?]') == ffi.typeof(a4) or ffi.typeof('const int32_t[?]') == ffi.typeof(a4) then
        return self:GetCursor_IntPtr(a2, a3, a4, a5, a6)
    end
...
function imguiGizmo:checkTowards(a2)
    -- generic version
...
function imguiGizmo:getTransforms(a2, a3, a4, a5)
    -- generic version
...
function M.imguiGizmo_setDirectionColor(a1, a2)
    -- generic version
    if (ffi.istype('uint32_t', a1) or type(a1) == 'number') and (ffi.istype('uint32_t', a2) or type(a2) == 'number') then
...
function M.imguiGizmo_setSphereColors(a1, a2)
    -- generic version
    if ffi.istype('const ImVec4', a1) then
...
function M.ImGuizmo_GetID(a1, a2)
    -- generic version
    if (ffi.istype('const char*', a1) or ffi.istype('char[]', a1) or type(a1) == 'string') and a2 == nil then
        return M.ImGuizmo_GetID_Str(a1)
    end
    if (ffi.istype('const char*', a1) or ffi.istype('char[]', a1) or type(a1) == 'string') and (ffi.istype('const char*', a2) or ffi.istype('char[]', a2) or type(a2) == 'string') then
...
function M.ImGuizmo_IsOver(a1, a2)
    -- generic version
    if a1 == nil then
...
function M.ImGuizmo_PushID(a1, a2)
    -- generic version
    if (ffi.istype('const char*', a1) or ffi.istype('char[]', a1) or type(a1) == 'string') and a2 == nil then
...
function M.ImGuizmo_ViewManipulate(a1, a2, a3, a4, a5, a6, a7, a8, a9)
    -- generic version
    if (ffi.istype('float', a2) or type(a2) == 'number') then
...
function M.ImNodes_Ez_PushStyleColor(a1, a2)
    -- generic version
    if (ffi.istype('uint32_t', a2) or type(a2) == 'number') then
...
function M.ImNodes_Ez_PushStyleVar(a1, a2)
    -- generic version
    if (ffi.istype('float', a2) or type(a2) == 'number') then
...
function M.ImPlot3D_AddColormap(a1, a2, a3, a4)
    -- generic version
    ...
    if ffi.typeof('uint32_t*') == ffi.typeof(a2) or ffi.typeof('const uint32_t*') == ffi.typeof(a2) or ffi.typeof('uint32_t[?]') == ffi.typeof(a2) or ffi.typeof('const uint32_t[?]') == ffi.typeof(a2) then
...
function M.ImPlot3D_PixelsToPlotPlane(a1, a2, a3, a4)
    -- generic version
    if ffi.istype('const ImVec2', a1) then
...
function M.ImPlot3D_PixelsToPlotRay(a1, a2)
    -- generic version
    if ffi.istype('const ImVec2', a1) then
...
function M.ImPlot3D_PlotImage(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12)
    -- generic version
...
function M.ImPlot3D_PlotLine(a1, a2, a3, a4, a5, a6)
    -- generic version
    if (ffi.istype('float*', a2) or ffi.istype('float[]', a2)) then
    ...
    if ffi.typeof('uint8_t*') == ffi.typeof(a2) or ffi.typeof('const uint8_t*') == ffi.typeof(a2) or ffi.typeof('uint8_t[?]') == ffi.typeof(a2) or ffi.typeof('const uint8_t[?]') == ffi.typeof(a2) then
        return M.ImPlot3D_PlotLine_U8Ptr(a1, a2, a3, a4, a5, a6)
    end
    if ffi.typeof('int16_t*') == ffi.typeof(a2) or ffi.typeof('const int16_t*') == ffi.typeof(a2) or ffi.typeof('int16_t[?]') == ffi.typeof(a2) or ffi.typeof('const int16_t[?]') == ffi.typeof(a2) then
        return M.ImPlot3D_PlotLine_S16Ptr(a1, a2, a3, a4, a5, a6)
    end
    if ffi.typeof('uint16_t*') == ffi.typeof(a2) or ffi.typeof('const uint16_t*') == ffi.typeof(a2) or ffi.typeof('uint16_t[?]') == ffi.typeof(a2) or ffi.typeof('const uint16_t[?]') == ffi.typeof(a2) then
        return M.ImPlot3D_PlotLine_U16Ptr(a1, a2, a3, a4, a5, a6)
    end
    if ffi.typeof('int32_t*') == ffi.typeof(a2) or ffi.typeof('const int32_t*') == ffi.typeof(a2) or ffi.typeof('int32_t[?]') == ffi.typeof(a2) or ffi.typeof('const int32_t[?]') == ffi.typeof(a2) then
        return M.ImPlot3D_PlotLine_S32Ptr(a1, a2, a3, a4, a5, a6)
    end
    if ffi.typeof('uint32_t*') == ffi.typeof(a2) or ffi.typeof('const uint32_t*') == ffi.typeof(a2) or ffi.typeof('uint32_t[?]') == ffi.typeof(a2) or ffi.typeof('const uint32_t[?]') == ffi.typeof(a2) then
        return M.ImPlot3D_PlotLine_U32Ptr(a1, a2, a3, a4, a5, a6)
    end
    if (ffi.istype('const ImS64*', a2) or ffi.istype('const ImS64', a2) or ffi.istype('const ImS64[]', a2)) then
        return M.ImPlot3D_PlotLine_S64Ptr(a1, a2, a3, a4, a5, a6)
    end
    if (ffi.istype('const ImU64*', a2) or ffi.istype('const ImU64', a2) or ffi.istype('const ImU64[]', a2)) then
...
function M.ImPlot3D_PlotMesh(a1, a2, a3, a4, a5, a6, a7, a8)
    -- generic version
    if (ffi.istype('float*', a2) or ffi.istype('float[]', a2)) then
...
function M.ImPlot3D_PlotQuad(a1, a2, a3, a4, a5, a6)
    -- generic version
    if (ffi.istype('float*', a2) or ffi.istype('float[]', a2)) then
...
function M.ImPlot3D_PlotScatter(a1, a2, a3, a4, a5, a6)
    -- generic version
    if (ffi.istype('float*', a2) or ffi.istype('float[]', a2)) then
...
function M.ImPlot3D_PlotSurface(a1, a2, a3, a4, a5, a6, a7, a8, a9)
    -- generic version
    if (ffi.istype('float*', a2) or ffi.istype('float[]', a2)) then
...
function M.ImPlot3D_PlotToPixels(a1, a2, a3)
    -- generic version
    if ffi.istype('const ImPlot3DPoint', a1) then
...
function M.ImPlot3D_PlotTriangle(a1, a2, a3, a4, a5, a6)
    -- generic version
    if (ffi.istype('float*', a2) or ffi.istype('float[]', a2)) then
...
function M.ImPlot3D_PushColormap(a1)
    -- generic version
    if (ffi.istype('int32_t', a1) or type(a1) == 'number') then
...
function M.ImPlot3D_PushStyleColor(a1, a2)
    -- generic version
    if (ffi.istype('uint32_t', a2) or type(a2) == 'number') then
...
function M.ImPlot3D_PushStyleVar(a1, a2)
    -- generic version
    if (ffi.istype('float', a2) or type(a2) == 'number') then
...
function M.ImPlot3D_SetupAxisScale(a1, a2, a3, a4)
    -- generic version
    if (ffi.istype('int32_t', a2) or type(a2) == 'number') then
...
function M.ImPlot3D_SetupAxisTicks(a1, a2, a3, a4, a5, a6)
    -- generic version
    if (ffi.istype('double*', a2) or ffi.istype('double[]', a2)) then
...
function M.ImPlot3D_SetupBoxInitialRotation(a1, a2)
    -- generic version
    if (ffi.istype('double', a1) or type(a1) == 'number') then
...
function M.ImPlot3D_SetupBoxRotation(a1, a2, a3, a4)
    -- generic version
    if (ffi.istype('double', a1) or type(a1) == 'number') then
...
function M.ImPlot_AddColormap(a1, a2, a3, a4)
    -- generic version
    if (ffi.istype('const ImVec4*', a2) or ffi.istype('const ImVec4', a2) or ffi.istype('const ImVec4[]', a2)) then
...
function M.ImPlot_Annotation(a1, a2, a3, a4, a5, a6, ...)
    -- generic version
...
function M.ImPlot_CalcTextColor(a1)
    -- generic version
    if ffi.istype('const ImVec4', a1) then
...
function M.ImPlot_FillRange(a1, a2, a3, a4)
    -- generic version
    if (ffi.istype('ImVector_float *', a1) or ffi.istype('ImVector_float ', a1) or ffi.istype('ImVector_float []', a1)) then
        return M.ImPlot_FillRange_Vector_Float_Ptr(a1, a2, a3, a4)
    end
    if (ffi.istype('ImVector_double *', a1) or ffi.istype('ImVector_double ', a1) or ffi.istype('ImVector_double []', a1)) then
    ...
    if (ffi.istype('ImVector_ImS16 *', a1) or ffi.istype('ImVector_ImS16 ', a1) or ffi.istype('ImVector_ImS16 []', a1)) then
        return M.ImPlot_FillRange_Vector_S16_Ptr(a1, a2, a3, a4)
    end
    if (ffi.istype('ImVector_ImU16 *', a1) or ffi.istype('ImVector_ImU16 ', a1) or ffi.istype('ImVector_ImU16 []', a1)) then
        return M.ImPlot_FillRange_Vector_U16_Ptr(a1, a2, a3, a4)
    end
    if (ffi.istype('ImVector_ImS32 *', a1) or ffi.istype('ImVector_ImS32 ', a1) or ffi.istype('ImVector_ImS32 []', a1)) then
        return M.ImPlot_FillRange_Vector_S32_Ptr(a1, a2, a3, a4)
    end
    if (ffi.istype('ImVector_ImU32 *', a1) or ffi.istype('ImVector_ImU32 ', a1) or ffi.istype('ImVector_ImU32 []', a1)) then
        return M.ImPlot_FillRange_Vector_U32_Ptr(a1, a2, a3, a4)
    end
    if (ffi.istype('ImVector_ImS64 *', a1) or ffi.istype('ImVector_ImS64 ', a1) or ffi.istype('ImVector_ImS64 []', a1)) then
        return M.ImPlot_FillRange_Vector_S64_Ptr(a1, a2, a3, a4)
    end
    if (ffi.istype('ImVector_ImU64 *', a1) or ffi.istype('ImVector_ImU64 ', a1) or ffi.istype('ImVector_ImU64 []', a1)) then
...
function M.ImPlot_ImMaxArray(a1, a2)
    -- generic version
    if (ffi.istype('float*', a1) or ffi.istype('float[]', a1)) then
    ...
    if ffi.typeof('uint8_t*') == ffi.typeof(a1) or ffi.typeof('const uint8_t*') == ffi.typeof(a1) or ffi.typeof('uint8_t[?]') == ffi.typeof(a1) or ffi.typeof('const uint8_t[?]') == ffi.typeof(a1) then
        return M.ImPlot_ImMaxArray_U8Ptr(a1, a2)
    end
    if ffi.typeof('int16_t*') == ffi.typeof(a1) or ffi.typeof('const int16_t*') == ffi.typeof(a1) or ffi.typeof('int16_t[?]') == ffi.typeof(a1) or ffi.typeof('const int16_t[?]') == ffi.typeof(a1) then
        return M.ImPlot_ImMaxArray_S16Ptr(a1, a2)
    end
    if ffi.typeof('uint16_t*') == ffi.typeof(a1) or ffi.typeof('const uint16_t*') == ffi.typeof(a1) or ffi.typeof('uint16_t[?]') == ffi.typeof(a1) or ffi.typeof('const uint16_t[?]') == ffi.typeof(a1) then
        return M.ImPlot_ImMaxArray_U16Ptr(a1, a2)
    end
    if ffi.typeof('int32_t*') == ffi.typeof(a1) or ffi.typeof('const int32_t*') == ffi.typeof(a1) or ffi.typeof('int32_t[?]') == ffi.typeof(a1) or ffi.typeof('const int32_t[?]') == ffi.typeof(a1) then
        return M.ImPlot_ImMaxArray_S32Ptr(a1, a2)
    end
    if ffi.typeof('uint32_t*') == ffi.typeof(a1) or ffi.typeof('const uint32_t*') == ffi.typeof(a1) or ffi.typeof('uint32_t[?]') == ffi.typeof(a1) or ffi.typeof('const uint32_t[?]') == ffi.typeof(a1) then
        return M.ImPlot_ImMaxArray_U32Ptr(a1, a2)
    end
    if (ffi.istype('const ImS64*', a1) or ffi.istype('const ImS64', a1) or ffi.istype('const ImS64[]', a1)) then
        return M.ImPlot_ImMaxArray_S64Ptr(a1, a2)
    end
    if (ffi.istype('const ImU64*', a1) or ffi.istype('const ImU64', a1) or ffi.istype('const ImU64[]', a1)) then
...
function M.ImPlot_ImMean(a1, a2)
    -- generic version
    if (ffi.istype('float*', a1) or ffi.istype('float[]', a1)) then
...
function M.ImPlot_ImMinArray(a1, a2)
    -- generic version
    if (ffi.istype('float*', a1) or ffi.istype('float[]', a1)) then
...
function M.ImPlot_ImMinMaxArray(a1, a2, a3, a4)
    -- generic version
    if (ffi.istype('float*', a1) or ffi.istype('float[]', a1)) then
...
function M.ImPlot_ImOverlaps(a1, a2, a3, a4)
    -- generic version
    if (ffi.istype('float', a1) or type(a1) == 'number') then
    ...
    if ffi.istype('ImS64', a1) then
        return M.ImPlot_ImOverlaps_S64(a1, a2, a3, a4)
    end
    if ffi.istype('ImU64', a1) then
...
function M.ImPlot_ImRemap(a1, a2, a3, a4, a5)
    -- generic version
    if (ffi.istype('float', a1) or type(a1) == 'number') then
...
function M.ImPlot_ImRemap01(a1, a2, a3)
    -- generic version
    if (ffi.istype('float', a1) or type(a1) == 'number') then
...
function M.ImPlot_ImStdDev(a1, a2)
    -- generic version
    if (ffi.istype('float*', a1) or ffi.istype('float[]', a1)) then
...
function M.ImPlot_IsColorAuto(a1)
    -- generic version
    if ffi.istype('const ImVec4', a1) then
...
function M.ImPlot_PixelsToPlot(a1, a2, a3, a4)
    -- generic version
    if ffi.istype('const ImVec2', a1) then
...
function M.ImPlot_PlotBarGroups(a1, a2, a3, a4, a5, a6, a7)
    -- generic version
    if (ffi.istype('float*', a2) or ffi.istype('float[]', a2)) then
...
function M.ImPlot_PlotBars(a1, a2, a3, a4, a5, a6)
    -- generic version
    if (ffi.istype('float*', a2) or ffi.istype('float[]', a2)) and (ffi.istype('int32_t', a3) or type(a3) == 'number') then
        return M.ImPlot_PlotBars_FloatPtrInt(a1, a2, a3, a4, a5, a6)
    end
    if (ffi.istype('double*', a2) or ffi.istype('double[]', a2)) and (ffi.istype('int32_t', a3) or type(a3) == 'number') then
        return M.ImPlot_PlotBars_doublePtrInt(a1, a2, a3, a4, a5, a6)
    end
    if (ffi.istype('const ImS8*', a2) or ffi.istype('char[]', a2) or type(a2) == 'string') and (ffi.istype('int32_t', a3) or type(a3) == 'number') then
        return M.ImPlot_PlotBars_S8PtrInt(a1, a2, a3, a4, a5, a6)
    end
    if ffi.typeof('uint8_t*') == ffi.typeof(a2) or ffi.typeof('const uint8_t*') == ffi.typeof(a2) or ffi.typeof('uint8_t[?]') == ffi.typeof(a2) or ffi.typeof('const uint8_t[?]') == ffi.typeof(a2) and (ffi.istype('int32_t', a3) or type(a3) == 'number') then
        return M.ImPlot_PlotBars_U8PtrInt(a1, a2, a3, a4, a5, a6)
    end
    if ffi.typeof('int16_t*') == ffi.typeof(a2) or ffi.typeof('const int16_t*') == ffi.typeof(a2) or ffi.typeof('int16_t[?]') == ffi.typeof(a2) or ffi.typeof('const int16_t[?]') == ffi.typeof(a2) and (ffi.istype('int32_t', a3) or type(a3) == 'number') then
        return M.ImPlot_PlotBars_S16PtrInt(a1, a2, a3, a4, a5, a6)
    end
    if ffi.typeof('uint16_t*') == ffi.typeof(a2) or ffi.typeof('const uint16_t*') == ffi.typeof(a2) or ffi.typeof('uint16_t[?]') == ffi.typeof(a2) or ffi.typeof('const uint16_t[?]') == ffi.typeof(a2) and (ffi.istype('int32_t', a3) or type(a3) == 'number') then
        return M.ImPlot_PlotBars_U16PtrInt(a1, a2, a3, a4, a5, a6)
    end
    if ffi.typeof('int32_t*') == ffi.typeof(a2) or ffi.typeof('const int32_t*') == ffi.typeof(a2) or ffi.typeof('int32_t[?]') == ffi.typeof(a2) or ffi.typeof('const int32_t[?]') == ffi.typeof(a2) and (ffi.istype('int32_t', a3) or type(a3) == 'number') then
        return M.ImPlot_PlotBars_S32PtrInt(a1, a2, a3, a4, a5, a6)
    end
    if ffi.typeof('uint32_t*') == ffi.typeof(a2) or ffi.typeof('const uint32_t*') == ffi.typeof(a2) or ffi.typeof('uint32_t[?]') == ffi.typeof(a2) or ffi.typeof('const uint32_t[?]') == ffi.typeof(a2) and (ffi.istype('int32_t', a3) or type(a3) == 'number') then
        return M.ImPlot_PlotBars_U32PtrInt(a1, a2, a3, a4, a5, a6)
    end
    if (ffi.istype('const ImS64*', a2) or ffi.istype('const ImS64', a2) or ffi.istype('const ImS64[]', a2)) and (ffi.istype('int32_t', a3) or type(a3) == 'number') then
        return M.ImPlot_PlotBars_S64PtrInt(a1, a2, a3, a4, a5, a6)
    end
    if (ffi.istype('const ImU64*', a2) or ffi.istype('const ImU64', a2) or ffi.istype('const ImU64[]', a2)) and (ffi.istype('int32_t', a3) or type(a3) == 'number') then
        return M.ImPlot_PlotBars_U64PtrInt(a1, a2, a3, a4, a5, a6)
    end
    if (ffi.istype('float*', a2) or ffi.istype('float[]', a2)) and (ffi.istype('float*', a3) or ffi.istype('float[]', a3)) then
        return M.ImPlot_PlotBars_FloatPtrFloatPtr(a1, a2, a3, a4, a5, a6)
    end
    if (ffi.istype('double*', a2) or ffi.istype('double[]', a2)) and (ffi.istype('double*', a3) or ffi.istype('double[]', a3)) then
        return M.ImPlot_PlotBars_doublePtrdoublePtr(a1, a2, a3, a4, a5, a6)
    end
    if (ffi.istype('const ImS8*', a2) or ffi.istype('char[]', a2) or type(a2) == 'string') and (ffi.istype('const ImS8*', a3) or ffi.istype('char[]', a3) or type(a3) == 'string') then
        return M.ImPlot_PlotBars_S8PtrS8Ptr(a1, a2, a3, a4, a5, a6)
    end
    if ffi.typeof('uint8_t*') == ffi.typeof(a2) or ffi.typeof('const uint8_t*') == ffi.typeof(a2) or ffi.typeof('uint8_t[?]') == ffi.typeof(a2) or ffi.typeof('const uint8_t[?]') == ffi.typeof(a2) and ffi.typeof('uint8_t*') == ffi.typeof(a3) or ffi.typeof('const uint8_t*') == ffi.typeof(a3) or ffi.typeof('uint8_t[?]') == ffi.typeof(a3) or ffi.typeof('const uint8_t[?]') == ffi.typeof(a3) then
        return M.ImPlot_PlotBars_U8PtrU8Ptr(a1, a2, a3, a4, a5, a6)
    end
    if ffi.typeof('int16_t*') == ffi.typeof(a2) or ffi.typeof('const int16_t*') == ffi.typeof(a2) or ffi.typeof('int16_t[?]') == ffi.typeof(a2) or ffi.typeof('const int16_t[?]') == ffi.typeof(a2) and ffi.typeof('int16_t*') == ffi.typeof(a3) or ffi.typeof('const int16_t*') == ffi.typeof(a3) or ffi.typeof('int16_t[?]') == ffi.typeof(a3) or ffi.typeof('const int16_t[?]') == ffi.typeof(a3) then
    ...
    if ffi.typeof('int32_t*') == ffi.typeof(a2) or ffi.typeof('const int32_t*') == ffi.typeof(a2) or ffi.typeof('int32_t[?]') == ffi.typeof(a2) or ffi.typeof('const int32_t[?]') == ffi.typeof(a2) and ffi.typeof('int32_t*') == ffi.typeof(a3) or ffi.typeof('const int32_t*') == ffi.typeof(a3) or ffi.typeof('int32_t[?]') == ffi.typeof(a3) or ffi.typeof('const int32_t[?]') == ffi.typeof(a3) then
        return M.ImPlot_PlotBars_S32PtrS32Ptr(a1, a2, a3, a4, a5, a6)
    end
    if ffi.typeof('uint32_t*') == ffi.typeof(a2) or ffi.typeof('const uint32_t*') == ffi.typeof(a2) or ffi.typeof('uint32_t[?]') == ffi.typeof(a2) or ffi.typeof('const uint32_t[?]') == ffi.typeof(a2) and ffi.typeof('uint32_t*') == ffi.typeof(a3) or ffi.typeof('const uint32_t*') == ffi.typeof(a3) or ffi.typeof('uint32_t[?]') == ffi.typeof(a3) or ffi.typeof('const uint32_t[?]') == ffi.typeof(a3) then
        return M.ImPlot_PlotBars_U32PtrU32Ptr(a1, a2, a3, a4, a5, a6)
    end
    if (ffi.istype('const ImS64*', a2) or ffi.istype('const ImS64', a2) or ffi.istype('const ImS64[]', a2)) and (ffi.istype('const ImS64*', a3) or ffi.istype('const ImS64', a3) or ffi.istype('const ImS64[]', a3)) then
        return M.ImPlot_PlotBars_S64PtrS64Ptr(a1, a2, a3, a4, a5, a6)
    end
    if (ffi.istype('const ImU64*', a2) or ffi.istype('const ImU64', a2) or ffi.istype('const ImU64[]', a2)) and (ffi.istype('const ImU64*', a3) or ffi.istype('const ImU64', a3) or ffi.istype('const ImU64[]', a3)) then
...
function M.ImPlot_PlotBubbles(a1, a2, a3, a4, a5, a6, a7)
    -- generic version
    if (ffi.istype('float*', a2) or ffi.istype('float[]', a2)) and (ffi.istype('float*', a3) or ffi.istype('float[]', a3)) and (ffi.istype('int32_t', a4) or type(a4) == 'number') then
        return M.ImPlot_PlotBubbles_FloatPtrFloatPtrInt(a1, a2, a3, a4, a5, a6, a7)
    end
    if (ffi.istype('double*', a2) or ffi.istype('double[]', a2)) and (ffi.istype('double*', a3) or ffi.istype('double[]', a3)) and (ffi.istype('int32_t', a4) or type(a4) == 'number') then
        return M.ImPlot_PlotBubbles_doublePtrdoublePtrInt(a1, a2, a3, a4, a5, a6, a7)
    end
    if (ffi.istype('const ImS8*', a2) or ffi.istype('char[]', a2) or type(a2) == 'string') and (ffi.istype('const ImS8*', a3) or ffi.istype('char[]', a3) or type(a3) == 'string') and (ffi.istype('int32_t', a4) or type(a4) == 'number') then
        return M.ImPlot_PlotBubbles_S8PtrS8PtrInt(a1, a2, a3, a4, a5, a6, a7)
    end
    if ffi.typeof('uint8_t*') == ffi.typeof(a2) or ffi.typeof('const uint8_t*') == ffi.typeof(a2) or ffi.typeof('uint8_t[?]') == ffi.typeof(a2) or ffi.typeof('const uint8_t[?]') == ffi.typeof(a2) and ffi.typeof('uint8_t*') == ffi.typeof(a3) or ffi.typeof('const uint8_t*') == ffi.typeof(a3) or ffi.typeof('uint8_t[?]') == ffi.typeof(a3) or ffi.typeof('const uint8_t[?]') == ffi.typeof(a3) and (ffi.istype('int32_t', a4) or type(a4) == 'number') then
        return M.ImPlot_PlotBubbles_U8PtrU8PtrInt(a1, a2, a3, a4, a5, a6, a7)
    end
    if ffi.typeof('int16_t*') == ffi.typeof(a2) or ffi.typeof('const int16_t*') == ffi.typeof(a2) or ffi.typeof('int16_t[?]') == ffi.typeof(a2) or ffi.typeof('const int16_t[?]') == ffi.typeof(a2) and ffi.typeof('int16_t*') == ffi.typeof(a3) or ffi.typeof('const int16_t*') == ffi.typeof(a3) or ffi.typeof('int16_t[?]') == ffi.typeof(a3) or ffi.typeof('const int16_t[?]') == ffi.typeof(a3) and (ffi.istype('int32_t', a4) or type(a4) == 'number') then
        return M.ImPlot_PlotBubbles_S16PtrS16PtrInt(a1, a2, a3, a4, a5, a6, a7)
    end
    if ffi.typeof('uint16_t*') == ffi.typeof(a2) or ffi.typeof('const uint16_t*') == ffi.typeof(a2) or ffi.typeof('uint16_t[?]') == ffi.typeof(a2) or ffi.typeof('const uint16_t[?]') == ffi.typeof(a2) and ffi.typeof('uint16_t*') == ffi.typeof(a3) or ffi.typeof('const uint16_t*') == ffi.typeof(a3) or ffi.typeof('uint16_t[?]') == ffi.typeof(a3) or ffi.typeof('const uint16_t[?]') == ffi.typeof(a3) and (ffi.istype('int32_t', a4) or type(a4) == 'number') then
        return M.ImPlot_PlotBubbles_U16PtrU16PtrInt(a1, a2, a3, a4, a5, a6, a7)
    end
    if ffi.typeof('int32_t*') == ffi.typeof(a2) or ffi.typeof('const int32_t*') == ffi.typeof(a2) or ffi.typeof('int32_t[?]') == ffi.typeof(a2) or ffi.typeof('const int32_t[?]') == ffi.typeof(a2) and ffi.typeof('int32_t*') == ffi.typeof(a3) or ffi.typeof('const int32_t*') == ffi.typeof(a3) or ffi.typeof('int32_t[?]') == ffi.typeof(a3) or ffi.typeof('const int32_t[?]') == ffi.typeof(a3) and (ffi.istype('int32_t', a4) or type(a4) == 'number') then
        return M.ImPlot_PlotBubbles_S32PtrS32PtrInt(a1, a2, a3, a4, a5, a6, a7)
    end
    if ffi.typeof('uint32_t*') == ffi.typeof(a2) or ffi.typeof('const uint32_t*') == ffi.typeof(a2) or ffi.typeof('uint32_t[?]') == ffi.typeof(a2) or ffi.typeof('const uint32_t[?]') == ffi.typeof(a2) and ffi.typeof('uint32_t*') == ffi.typeof(a3) or ffi.typeof('const uint32_t*') == ffi.typeof(a3) or ffi.typeof('uint32_t[?]') == ffi.typeof(a3) or ffi.typeof('const uint32_t[?]') == ffi.typeof(a3) and (ffi.istype('int32_t', a4) or type(a4) == 'number') then
        return M.ImPlot_PlotBubbles_U32PtrU32PtrInt(a1, a2, a3, a4, a5, a6, a7)
    end
    if (ffi.istype('const ImS64*', a2) or ffi.istype('const ImS64', a2) or ffi.istype('const ImS64[]', a2)) and (ffi.istype('const ImS64*', a3) or ffi.istype('const ImS64', a3) or ffi.istype('const ImS64[]', a3)) and (ffi.istype('int32_t', a4) or type(a4) == 'number') then
        return M.ImPlot_PlotBubbles_S64PtrS64PtrInt(a1, a2, a3, a4, a5, a6, a7)
    end
    if (ffi.istype('const ImU64*', a2) or ffi.istype('const ImU64', a2) or ffi.istype('const ImU64[]', a2)) and (ffi.istype('const ImU64*', a3) or ffi.istype('const ImU64', a3) or ffi.istype('const ImU64[]', a3)) and (ffi.istype('int32_t', a4) or type(a4) == 'number') then
        return M.ImPlot_PlotBubbles_U64PtrU64PtrInt(a1, a2, a3, a4, a5, a6, a7)
    end
    if (ffi.istype('float*', a2) or ffi.istype('float[]', a2)) and (ffi.istype('float*', a3) or ffi.istype('float[]', a3)) and (ffi.istype('float*', a4) or ffi.istype('float[]', a4)) then
        return M.ImPlot_PlotBubbles_FloatPtrFloatPtrFloatPtr(a1, a2, a3, a4, a5, a6)
    end
    if (ffi.istype('double*', a2) or ffi.istype('double[]', a2)) and (ffi.istype('double*', a3) or ffi.istype('double[]', a3)) and (ffi.istype('double*', a4) or ffi.istype('double[]', a4)) then
        return M.ImPlot_PlotBubbles_doublePtrdoublePtrdoublePtr(a1, a2, a3, a4, a5, a6)
    end
    if (ffi.istype('const ImS8*', a2) or ffi.istype('char[]', a2) or type(a2) == 'string') and (ffi.istype('const ImS8*', a3) or ffi.istype('char[]', a3) or type(a3) == 'string') and (ffi.istype('const ImS8*', a4) or ffi.istype('char[]', a4) or type(a4) == 'string') then
        return M.ImPlot_PlotBubbles_S8PtrS8PtrS8Ptr(a1, a2, a3, a4, a5, a6)
    end
    if ffi.typeof('uint8_t*') == ffi.typeof(a2) or ffi.typeof('const uint8_t*') == ffi.typeof(a2) or ffi.typeof('uint8_t[?]') == ffi.typeof(a2) or ffi.typeof('const uint8_t[?]') == ffi.typeof(a2) and ffi.typeof('uint8_t*') == ffi.typeof(a3) or ffi.typeof('const uint8_t*') == ffi.typeof(a3) or ffi.typeof('uint8_t[?]') == ffi.typeof(a3) or ffi.typeof('const uint8_t[?]') == ffi.typeof(a3) and ffi.typeof('uint8_t*') == ffi.typeof(a4) or ffi.typeof('const uint8_t*') == ffi.typeof(a4) or ffi.typeof('uint8_t[?]') == ffi.typeof(a4) or ffi.typeof('const uint8_t[?]') == ffi.typeof(a4) then
        return M.ImPlot_PlotBubbles_U8PtrU8PtrU8Ptr(a1, a2, a3, a4, a5, a6)
    end
    if ffi.typeof('int16_t*') == ffi.typeof(a2) or ffi.typeof('const int16_t*') == ffi.typeof(a2) or ffi.typeof('int16_t[?]') == ffi.typeof(a2) or ffi.typeof('const int16_t[?]') == ffi.typeof(a2) and ffi.typeof('int16_t*') == ffi.typeof(a3) or ffi.typeof('const int16_t*') == ffi.typeof(a3) or ffi.typeof('int16_t[?]') == ffi.typeof(a3) or ffi.typeof('const int16_t[?]') == ffi.typeof(a3) and ffi.typeof('int16_t*') == ffi.typeof(a4) or ffi.typeof('const int16_t*') == ffi.typeof(a4) or ffi.typeof('int16_t[?]') == ffi.typeof(a4) or ffi.typeof('const int16_t[?]') == ffi.typeof(a4) then
    ...
    if ffi.typeof('int32_t*') == ffi.typeof(a2) or ffi.typeof('const int32_t*') == ffi.typeof(a2) or ffi.typeof('int32_t[?]') == ffi.typeof(a2) or ffi.typeof('const int32_t[?]') == ffi.typeof(a2) and ffi.typeof('int32_t*') == ffi.typeof(a3) or ffi.typeof('const int32_t*') == ffi.typeof(a3) or ffi.typeof('int32_t[?]') == ffi.typeof(a3) or ffi.typeof('const int32_t[?]') == ffi.typeof(a3) and ffi.typeof('int32_t*') == ffi.typeof(a4) or ffi.typeof('const int32_t*') == ffi.typeof(a4) or ffi.typeof('int32_t[?]') == ffi.typeof(a4) or ffi.typeof('const int32_t[?]') == ffi.typeof(a4) then
        return M.ImPlot_PlotBubbles_S32PtrS32PtrS32Ptr(a1, a2, a3, a4, a5, a6)
    end
    if ffi.typeof('uint32_t*') == ffi.typeof(a2) or ffi.typeof('const uint32_t*') == ffi.typeof(a2) or ffi.typeof('uint32_t[?]') == ffi.typeof(a2) or ffi.typeof('const uint32_t[?]') == ffi.typeof(a2) and ffi.typeof('uint32_t*') == ffi.typeof(a3) or ffi.typeof('const uint32_t*') == ffi.typeof(a3) or ffi.typeof('uint32_t[?]') == ffi.typeof(a3) or ffi.typeof('const uint32_t[?]') == ffi.typeof(a3) and ffi.typeof('uint32_t*') == ffi.typeof(a4) or ffi.typeof('const uint32_t*') == ffi.typeof(a4) or ffi.typeof('uint32_t[?]') == ffi.typeof(a4) or ffi.typeof('const uint32_t[?]') == ffi.typeof(a4) then
        return M.ImPlot_PlotBubbles_U32PtrU32PtrU32Ptr(a1, a2, a3, a4, a5, a6)
    end
    if (ffi.istype('const ImS64*', a2) or ffi.istype('const ImS64', a2) or ffi.istype('const ImS64[]', a2)) and (ffi.istype('const ImS64*', a3) or ffi.istype('const ImS64', a3) or ffi.istype('const ImS64[]', a3)) and (ffi.istype('const ImS64*', a4) or ffi.istype('const ImS64', a4) or ffi.istype('const ImS64[]', a4)) then
        return M.ImPlot_PlotBubbles_S64PtrS64PtrS64Ptr(a1, a2, a3, a4, a5, a6)
    end
    if (ffi.istype('const ImU64*', a2) or ffi.istype('const ImU64', a2) or ffi.istype('const ImU64[]', a2)) and (ffi.istype('const ImU64*', a3) or ffi.istype('const ImU64', a3) or ffi.istype('const ImU64[]', a3)) and (ffi.istype('const ImU64*', a4) or ffi.istype('const ImU64', a4) or ffi.istype('const ImU64[]', a4)) then
...
function M.ImPlot_PlotDigital(a1, a2, a3, a4, a5)
    -- generic version
    if (ffi.istype('float*', a2) or ffi.istype('float[]', a2)) then
...
function M.ImPlot_PlotErrorBars(a1, a2, a3, a4, a5, a6, a7)
    -- generic version
    if (ffi.istype('float*', a2) or ffi.istype('float[]', a2)) and (ffi.istype('float*', a3) or ffi.istype('float[]', a3)) and (ffi.istype('float*', a4) or ffi.istype('float[]', a4)) and (ffi.istype('int32_t', a5) or type(a5) == 'number') then
        return M.ImPlot_PlotErrorBars_FloatPtrFloatPtrFloatPtrInt(a1, a2, a3, a4, a5, a6)
    end
    if (ffi.istype('double*', a2) or ffi.istype('double[]', a2)) and (ffi.istype('double*', a3) or ffi.istype('double[]', a3)) and (ffi.istype('double*', a4) or ffi.istype('double[]', a4)) and (ffi.istype('int32_t', a5) or type(a5) == 'number') then
        return M.ImPlot_PlotErrorBars_doublePtrdoublePtrdoublePtrInt(a1, a2, a3, a4, a5, a6)
    end
    if (ffi.istype('const ImS8*', a2) or ffi.istype('char[]', a2) or type(a2) == 'string') and (ffi.istype('const ImS8*', a3) or ffi.istype('char[]', a3) or type(a3) == 'string') and (ffi.istype('const ImS8*', a4) or ffi.istype('char[]', a4) or type(a4) == 'string') and (ffi.istype('int32_t', a5) or type(a5) == 'number') then
        return M.ImPlot_PlotErrorBars_S8PtrS8PtrS8PtrInt(a1, a2, a3, a4, a5, a6)
    end
    if ffi.typeof('uint8_t*') == ffi.typeof(a2) or ffi.typeof('const uint8_t*') == ffi.typeof(a2) or ffi.typeof('uint8_t[?]') == ffi.typeof(a2) or ffi.typeof('const uint8_t[?]') == ffi.typeof(a2) and ffi.typeof('uint8_t*') == ffi.typeof(a3) or ffi.typeof('const uint8_t*') == ffi.typeof(a3) or ffi.typeof('uint8_t[?]') == ffi.typeof(a3) or ffi.typeof('const uint8_t[?]') == ffi.typeof(a3) and ffi.typeof('uint8_t*') == ffi.typeof(a4) or ffi.typeof('const uint8_t*') == ffi.typeof(a4) or ffi.typeof('uint8_t[?]') == ffi.typeof(a4) or ffi.typeof('const uint8_t[?]') == ffi.typeof(a4) and (ffi.istype('int32_t', a5) or type(a5) == 'number') then
        return M.ImPlot_PlotErrorBars_U8PtrU8PtrU8PtrInt(a1, a2, a3, a4, a5, a6)
    end
    if ffi.typeof('int16_t*') == ffi.typeof(a2) or ffi.typeof('const int16_t*') == ffi.typeof(a2) or ffi.typeof('int16_t[?]') == ffi.typeof(a2) or ffi.typeof('const int16_t[?]') == ffi.typeof(a2) and ffi.typeof('int16_t*') == ffi.typeof(a3) or ffi.typeof('const int16_t*') == ffi.typeof(a3) or ffi.typeof('int16_t[?]') == ffi.typeof(a3) or ffi.typeof('const int16_t[?]') == ffi.typeof(a3) and ffi.typeof('int16_t*') == ffi.typeof(a4) or ffi.typeof('const int16_t*') == ffi.typeof(a4) or ffi.typeof('int16_t[?]') == ffi.typeof(a4) or ffi.typeof('const int16_t[?]') == ffi.typeof(a4) and (ffi.istype('int32_t', a5) or type(a5) == 'number') then
        return M.ImPlot_PlotErrorBars_S16PtrS16PtrS16PtrInt(a1, a2, a3, a4, a5, a6)
    end
    if ffi.typeof('uint16_t*') == ffi.typeof(a2) or ffi.typeof('const uint16_t*') == ffi.typeof(a2) or ffi.typeof('uint16_t[?]') == ffi.typeof(a2) or ffi.typeof('const uint16_t[?]') == ffi.typeof(a2) and ffi.typeof('uint16_t*') == ffi.typeof(a3) or ffi.typeof('const uint16_t*') == ffi.typeof(a3) or ffi.typeof('uint16_t[?]') == ffi.typeof(a3) or ffi.typeof('const uint16_t[?]') == ffi.typeof(a3) and ffi.typeof('uint16_t*') == ffi.typeof(a4) or ffi.typeof('const uint16_t*') == ffi.typeof(a4) or ffi.typeof('uint16_t[?]') == ffi.typeof(a4) or ffi.typeof('const uint16_t[?]') == ffi.typeof(a4) and (ffi.istype('int32_t', a5) or type(a5) == 'number') then
        return M.ImPlot_PlotErrorBars_U16PtrU16PtrU16PtrInt(a1, a2, a3, a4, a5, a6)
    end
    if ffi.typeof('int32_t*') == ffi.typeof(a2) or ffi.typeof('const int32_t*') == ffi.typeof(a2) or ffi.typeof('int32_t[?]') == ffi.typeof(a2) or ffi.typeof('const int32_t[?]') == ffi.typeof(a2) and ffi.typeof('int32_t*') == ffi.typeof(a3) or ffi.typeof('const int32_t*') == ffi.typeof(a3) or ffi.typeof('int32_t[?]') == ffi.typeof(a3) or ffi.typeof('const int32_t[?]') == ffi.typeof(a3) and ffi.typeof('int32_t*') == ffi.typeof(a4) or ffi.typeof('const int32_t*') == ffi.typeof(a4) or ffi.typeof('int32_t[?]') == ffi.typeof(a4) or ffi.typeof('const int32_t[?]') == ffi.typeof(a4) and (ffi.istype('int32_t', a5) or type(a5) == 'number') then
        return M.ImPlot_PlotErrorBars_S32PtrS32PtrS32PtrInt(a1, a2, a3, a4, a5, a6)
    end
    if ffi.typeof('uint32_t*') == ffi.typeof(a2) or ffi.typeof('const uint32_t*') == ffi.typeof(a2) or ffi.typeof('uint32_t[?]') == ffi.typeof(a2) or ffi.typeof('const uint32_t[?]') == ffi.typeof(a2) and ffi.typeof('uint32_t*') == ffi.typeof(a3) or ffi.typeof('const uint32_t*') == ffi.typeof(a3) or ffi.typeof('uint32_t[?]') == ffi.typeof(a3) or ffi.typeof('const uint32_t[?]') == ffi.typeof(a3) and ffi.typeof('uint32_t*') == ffi.typeof(a4) or ffi.typeof('const uint32_t*') == ffi.typeof(a4) or ffi.typeof('uint32_t[?]') == ffi.typeof(a4) or ffi.typeof('const uint32_t[?]') == ffi.typeof(a4) and (ffi.istype('int32_t', a5) or type(a5) == 'number') then
        return M.ImPlot_PlotErrorBars_U32PtrU32PtrU32PtrInt(a1, a2, a3, a4, a5, a6)
    end
    if (ffi.istype('const ImS64*', a2) or ffi.istype('const ImS64', a2) or ffi.istype('const ImS64[]', a2)) and (ffi.istype('const ImS64*', a3) or ffi.istype('const ImS64', a3) or ffi.istype('const ImS64[]', a3)) and (ffi.istype('const ImS64*', a4) or ffi.istype('const ImS64', a4) or ffi.istype('const ImS64[]', a4)) and (ffi.istype('int32_t', a5) or type(a5) == 'number') then
        return M.ImPlot_PlotErrorBars_S64PtrS64PtrS64PtrInt(a1, a2, a3, a4, a5, a6)
    end
    if (ffi.istype('const ImU64*', a2) or ffi.istype('const ImU64', a2) or ffi.istype('const ImU64[]', a2)) and (ffi.istype('const ImU64*', a3) or ffi.istype('const ImU64', a3) or ffi.istype('const ImU64[]', a3)) and (ffi.istype('const ImU64*', a4) or ffi.istype('const ImU64', a4) or ffi.istype('const ImU64[]', a4)) and (ffi.istype('int32_t', a5) or type(a5) == 'number') then
        return M.ImPlot_PlotErrorBars_U64PtrU64PtrU64PtrInt(a1, a2, a3, a4, a5, a6)
    end
    if (ffi.istype('float*', a2) or ffi.istype('float[]', a2)) and (ffi.istype('float*', a3) or ffi.istype('float[]', a3)) and (ffi.istype('float*', a4) or ffi.istype('float[]', a4)) and (ffi.istype('float*', a5) or ffi.istype('float[]', a5)) then
        return M.ImPlot_PlotErrorBars_FloatPtrFloatPtrFloatPtrFloatPtr(a1, a2, a3, a4, a5, a6, a7)
    end
    if (ffi.istype('double*', a2) or ffi.istype('double[]', a2)) and (ffi.istype('double*', a3) or ffi.istype('double[]', a3)) and (ffi.istype('double*', a4) or ffi.istype('double[]', a4)) and (ffi.istype('double*', a5) or ffi.istype('double[]', a5)) then
        return M.ImPlot_PlotErrorBars_doublePtrdoublePtrdoublePtrdoublePtr(a1, a2, a3, a4, a5, a6, a7)
    end
    if (ffi.istype('const ImS8*', a2) or ffi.istype('char[]', a2) or type(a2) == 'string') and (ffi.istype('const ImS8*', a3) or ffi.istype('char[]', a3) or type(a3) == 'string') and (ffi.istype('const ImS8*', a4) or ffi.istype('char[]', a4) or type(a4) == 'string') and (ffi.istype('const ImS8*', a5) or ffi.istype('char[]', a5) or type(a5) == 'string') then
        return M.ImPlot_PlotErrorBars_S8PtrS8PtrS8PtrS8Ptr(a1, a2, a3, a4, a5, a6, a7)
    end
    if ffi.typeof('uint8_t*') == ffi.typeof(a2) or ffi.typeof('const uint8_t*') == ffi.typeof(a2) or ffi.typeof('uint8_t[?]') == ffi.typeof(a2) or ffi.typeof('const uint8_t[?]') == ffi.typeof(a2) and ffi.typeof('uint8_t*') == ffi.typeof(a3) or ffi.typeof('const uint8_t*') == ffi.typeof(a3) or ffi.typeof('uint8_t[?]') == ffi.typeof(a3) or ffi.typeof('const uint8_t[?]') == ffi.typeof(a3) and ffi.typeof('uint8_t*') == ffi.typeof(a4) or ffi.typeof('const uint8_t*') == ffi.typeof(a4) or ffi.typeof('uint8_t[?]') == ffi.typeof(a4) or ffi.typeof('const uint8_t[?]') == ffi.typeof(a4) and ffi.typeof('uint8_t*') == ffi.typeof(a5) or ffi.typeof('const uint8_t*') == ffi.typeof(a5) or ffi.typeof('uint8_t[?]') == ffi.typeof(a5) or ffi.typeof('const uint8_t[?]') == ffi.typeof(a5) then
        return M.ImPlot_PlotErrorBars_U8PtrU8PtrU8PtrU8Ptr(a1, a2, a3, a4, a5, a6, a7)
    end
    if ffi.typeof('int16_t*') == ffi.typeof(a2) or ffi.typeof('const int16_t*') == ffi.typeof(a2) or ffi.typeof('int16_t[?]') == ffi.typeof(a2) or ffi.typeof('const int16_t[?]') == ffi.typeof(a2) and ffi.typeof('int16_t*') == ffi.typeof(a3) or ffi.typeof('const int16_t*') == ffi.typeof(a3) or ffi.typeof('int16_t[?]') == ffi.typeof(a3) or ffi.typeof('const int16_t[?]') == ffi.typeof(a3) and ffi.typeof('int16_t*') == ffi.typeof(a4) or ffi.typeof('const int16_t*') == ffi.typeof(a4) or ffi.typeof('int16_t[?]') == ffi.typeof(a4) or ffi.typeof('const int16_t[?]') == ffi.typeof(a4) and ffi.typeof('int16_t*') == ffi.typeof(a5) or ffi.typeof('const int16_t*') == ffi.typeof(a5) or ffi.typeof('int16_t[?]') == ffi.typeof(a5) or ffi.typeof('const int16_t[?]') == ffi.typeof(a5) then
    ...
    if ffi.typeof('int32_t*') == ffi.typeof(a2) or ffi.typeof('const int32_t*') == ffi.typeof(a2) or ffi.typeof('int32_t[?]') == ffi.typeof(a2) or ffi.typeof('const int32_t[?]') == ffi.typeof(a2) and ffi.typeof('int32_t*') == ffi.typeof(a3) or ffi.typeof('const int32_t*') == ffi.typeof(a3) or ffi.typeof('int32_t[?]') == ffi.typeof(a3) or ffi.typeof('const int32_t[?]') == ffi.typeof(a3) and ffi.typeof('int32_t*') == ffi.typeof(a4) or ffi.typeof('const int32_t*') == ffi.typeof(a4) or ffi.typeof('int32_t[?]') == ffi.typeof(a4) or ffi.typeof('const int32_t[?]') == ffi.typeof(a4) and ffi.typeof('int32_t*') == ffi.typeof(a5) or ffi.typeof('const int32_t*') == ffi.typeof(a5) or ffi.typeof('int32_t[?]') == ffi.typeof(a5) or ffi.typeof('const int32_t[?]') == ffi.typeof(a5) then
        return M.ImPlot_PlotErrorBars_S32PtrS32PtrS32PtrS32Ptr(a1, a2, a3, a4, a5, a6, a7)
    end
    if ffi.typeof('uint32_t*') == ffi.typeof(a2) or ffi.typeof('const uint32_t*') == ffi.typeof(a2) or ffi.typeof('uint32_t[?]') == ffi.typeof(a2) or ffi.typeof('const uint32_t[?]') == ffi.typeof(a2) and ffi.typeof('uint32_t*') == ffi.typeof(a3) or ffi.typeof('const uint32_t*') == ffi.typeof(a3) or ffi.typeof('uint32_t[?]') == ffi.typeof(a3) or ffi.typeof('const uint32_t[?]') == ffi.typeof(a3) and ffi.typeof('uint32_t*') == ffi.typeof(a4) or ffi.typeof('const uint32_t*') == ffi.typeof(a4) or ffi.typeof('uint32_t[?]') == ffi.typeof(a4) or ffi.typeof('const uint32_t[?]') == ffi.typeof(a4) and ffi.typeof('uint32_t*') == ffi.typeof(a5) or ffi.typeof('const uint32_t*') == ffi.typeof(a5) or ffi.typeof('uint32_t[?]') == ffi.typeof(a5) or ffi.typeof('const uint32_t[?]') == ffi.typeof(a5) then
...
function M.ImPlot_PlotHeatmap_FloatPtr(label_id, values, rows, cols, scale_min, scale_max, label_fmt, bounds_min, bounds_max, spec)
    ...
    scale_min = scale_min or 0
    spec = spec or M.ImPlotSpec()[0]
    return lib.ImPlot_PlotHeatmap_FloatPtr(label_id, values, rows, cols, scale_min, scale_max, label_fmt, bounds_min, bounds_max, spec)
end
function M.ImPlot_PlotHeatmap_doublePtr(label_id, values, rows, cols, scale_min, scale_max, label_fmt, bounds_min, bounds_max, spec)
    bounds_max = bounds_max or ImPlotPoint(1, 1)
    bounds_min = bounds_min or ImPlotPoint(0, 0)
    label_fmt = label_fmt or "%.1f"
    scale_max = scale_max or 0
    scale_min = scale_min or 0
    spec = spec or M.ImPlotSpec()[0]
    return lib.ImPlot_PlotHeatmap_doublePtr(label_id, values, rows, cols, scale_min, scale_max, label_fmt, bounds_min, bounds_max, spec)
end
function M.ImPlot_PlotHeatmap_S8Ptr(label_id, values, rows, cols, scale_min, scale_max, label_fmt, bounds_min, bounds_max, spec)
    bounds_max = bounds_max or ImPlotPoint(1, 1)
    bounds_min = bounds_min or ImPlotPoint(0, 0)
    label_fmt = label_fmt or "%.1f"
    scale_max = scale_max or 0
    scale_min = scale_min or 0
    spec = spec or M.ImPlotSpec()[0]
    return lib.ImPlot_PlotHeatmap_S8Ptr(label_id, values, rows, cols, scale_min, scale_max, label_fmt, bounds_min, bounds_max, spec)
end
function M.ImPlot_PlotHeatmap_U8Ptr(label_id, values, rows, cols, scale_min, scale_max, label_fmt, bounds_min, bounds_max, spec)
    bounds_max = bounds_max or ImPlotPoint(1, 1)
    bounds_min = bounds_min or ImPlotPoint(0, 0)
    label_fmt = label_fmt or "%.1f"
    scale_max = scale_max or 0
    scale_min = scale_min or 0
    spec = spec or M.ImPlotSpec()[0]
    return lib.ImPlot_PlotHeatmap_U8Ptr(label_id, values, rows, cols, scale_min, scale_max, label_fmt, bounds_min, bounds_max, spec)
end
function M.ImPlot_PlotHeatmap_S16Ptr(label_id, values, rows, cols, scale_min, scale_max, label_fmt, bounds_min, bounds_max, spec)
    bounds_max = bounds_max or ImPlotPoint(1, 1)
    bounds_min = bounds_min or ImPlotPoint(0, 0)
    label_fmt = label_fmt or "%.1f"
    scale_max = scale_max or 0
    scale_min = scale_min or 0
    spec = spec or M.ImPlotSpec()[0]
    return lib.ImPlot_PlotHeatmap_S16Ptr(label_id, values, rows, cols, scale_min, scale_max, label_fmt, bounds_min, bounds_max, spec)
end
function M.ImPlot_PlotHeatmap_U16Ptr(label_id, values, rows, cols, scale_min, scale_max, label_fmt, bounds_min, bounds_max, spec)
    bounds_max = bounds_max or ImPlotPoint(1, 1)
    bounds_min = bounds_min or ImPlotPoint(0, 0)
    label_fmt = label_fmt or "%.1f"
    scale_max = scale_max or 0
    scale_min = scale_min or 0
    spec = spec or M.ImPlotSpec()[0]
    return lib.ImPlot_PlotHeatmap_U16Ptr(label_id, values, rows, cols, scale_min, scale_max, label_fmt, bounds_min, bounds_max, spec)
end
function M.ImPlot_PlotHeatmap_S32Ptr(label_id, values, rows, cols, scale_min, scale_max, label_fmt, bounds_min, bounds_max, spec)
    bounds_max = bounds_max or ImPlotPoint(1, 1)
    bounds_min = bounds_min or ImPlotPoint(0, 0)
    label_fmt = label_fmt or "%.1f"
    scale_max = scale_max or 0
    scale_min = scale_min or 0
    spec = spec or M.ImPlotSpec()[0]
    return lib.ImPlot_PlotHeatmap_S32Ptr(label_id, values, rows, cols, scale_min, scale_max, label_fmt, bounds_min, bounds_max, spec)
end
function M.ImPlot_PlotHeatmap_U32Ptr(label_id, values, rows, cols, scale_min, scale_max, label_fmt, bounds_min, bounds_max, spec)
    bounds_max = bounds_max or ImPlotPoint(1, 1)
    bounds_min = bounds_min or ImPlotPoint(0, 0)
    label_fmt = label_fmt or "%.1f"
    scale_max = scale_max or 0
    scale_min = scale_min or 0
    spec = spec or M.ImPlotSpec()[0]
    return lib.ImPlot_PlotHeatmap_U32Ptr(label_id, values, rows, cols, scale_min, scale_max, label_fmt, bounds_min, bounds_max, spec)
end
function M.ImPlot_PlotHeatmap_S64Ptr(label_id, values, rows, cols, scale_min, scale_max, label_fmt, bounds_min, bounds_max, spec)
    bounds_max = bounds_max or ImPlotPoint(1, 1)
    bounds_min = bounds_min or ImPlotPoint(0, 0)
    label_fmt = label_fmt or "%.1f"
    scale_max = scale_max or 0
    scale_min = scale_min or 0
    spec = spec or M.ImPlotSpec()[0]
    return lib.ImPlot_PlotHeatmap_S64Ptr(label_id, values, rows, cols, scale_min, scale_max, label_fmt, bounds_min, bounds_max, spec)
end
function M.ImPlot_PlotHeatmap_U64Ptr(label_id, values, rows, cols, scale_min, scale_max, label_fmt, bounds_min, bounds_max, spec)
    bounds_max = bounds_max or ImPlotPoint(1, 1)
    bounds_min = bounds_min or ImPlotPoint(0, 0)
    label_fmt = label_fmt or "%.1f"
    scale_max = scale_max or 0
    scale_min = scale_min or 0
    spec = spec or M.ImPlotSpec()[0]
    return lib.ImPlot_PlotHeatmap_U64Ptr(label_id, values, rows, cols, scale_min, scale_max, label_fmt, bounds_min, bounds_max, spec)
end
function M.ImPlot_PlotHeatmap(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10)
    -- generic version
    if (ffi.istype('float*', a2) or ffi.istype('float[]', a2)) then
...
function M.ImPlot_PlotHistogram(a1, a2, a3, a4, a5, a6, a7)
    -- generic version
    if (ffi.istype('float*', a2) or ffi.istype('float[]', a2)) then
...
function M.ImPlot_PlotHistogram2D(a1, a2, a3, a4, a5, a6, a7, a8)
    -- generic version
    if (ffi.istype('float*', a2) or ffi.istype('float[]', a2)) then
...
function M.ImPlot_PlotInfLines(a1, a2, a3, a4)
    -- generic version
    if (ffi.istype('float*', a2) or ffi.istype('float[]', a2)) then
...
function M.ImPlot_PlotLine(a1, a2, a3, a4, a5, a6)
    -- generic version
    if (ffi.istype('float*', a2) or ffi.istype('float[]', a2)) and (ffi.istype('int32_t', a3) or type(a3) == 'number') then
...
function M.ImPlot_PlotPieChart_FloatPtrPlotFormatter(label_ids, values, count, x, y, radius, fmt, fmt_data, angle0, spec)
    angle0 = angle0 or 90
    fmt_data = fmt_data or nil
    spec = spec or M.ImPlotSpec()[0]
    return lib.ImPlot_PlotPieChart_FloatPtrPlotFormatter(label_ids, values, count, x, y, radius, fmt, fmt_data, angle0, spec)
end
function M.ImPlot_PlotPieChart_doublePtrPlotFormatter(label_ids, values, count, x, y, radius, fmt, fmt_data, angle0, spec)
    angle0 = angle0 or 90
    fmt_data = fmt_data or nil
    spec = spec or M.ImPlotSpec()[0]
    return lib.ImPlot_PlotPieChart_doublePtrPlotFormatter(label_ids, values, count, x, y, radius, fmt, fmt_data, angle0, spec)
end
function M.ImPlot_PlotPieChart_S8PtrPlotFormatter(label_ids, values, count, x, y, radius, fmt, fmt_data, angle0, spec)
    angle0 = angle0 or 90
    fmt_data = fmt_data or nil
    spec = spec or M.ImPlotSpec()[0]
    return lib.ImPlot_PlotPieChart_S8PtrPlotFormatter(label_ids, values, count, x, y, radius, fmt, fmt_data, angle0, spec)
end
function M.ImPlot_PlotPieChart_U8PtrPlotFormatter(label_ids, values, count, x, y, radius, fmt, fmt_data, angle0, spec)
    angle0 = angle0 or 90
    fmt_data = fmt_data or nil
    spec = spec or M.ImPlotSpec()[0]
    return lib.ImPlot_PlotPieChart_U8PtrPlotFormatter(label_ids, values, count, x, y, radius, fmt, fmt_data, angle0, spec)
end
function M.ImPlot_PlotPieChart_S16PtrPlotFormatter(label_ids, values, count, x, y, radius, fmt, fmt_data, angle0, spec)
    angle0 = angle0 or 90
    fmt_data = fmt_data or nil
    spec = spec or M.ImPlotSpec()[0]
    return lib.ImPlot_PlotPieChart_S16PtrPlotFormatter(label_ids, values, count, x, y, radius, fmt, fmt_data, angle0, spec)
end
function M.ImPlot_PlotPieChart_U16PtrPlotFormatter(label_ids, values, count, x, y, radius, fmt, fmt_data, angle0, spec)
    angle0 = angle0 or 90
    fmt_data = fmt_data or nil
    spec = spec or M.ImPlotSpec()[0]
    return lib.ImPlot_PlotPieChart_U16PtrPlotFormatter(label_ids, values, count, x, y, radius, fmt, fmt_data, angle0, spec)
end
function M.ImPlot_PlotPieChart_S32PtrPlotFormatter(label_ids, values, count, x, y, radius, fmt, fmt_data, angle0, spec)
    angle0 = angle0 or 90
    fmt_data = fmt_data or nil
    spec = spec or M.ImPlotSpec()[0]
    return lib.ImPlot_PlotPieChart_S32PtrPlotFormatter(label_ids, values, count, x, y, radius, fmt, fmt_data, angle0, spec)
end
function M.ImPlot_PlotPieChart_U32PtrPlotFormatter(label_ids, values, count, x, y, radius, fmt, fmt_data, angle0, spec)
    angle0 = angle0 or 90
    fmt_data = fmt_data or nil
    spec = spec or M.ImPlotSpec()[0]
    return lib.ImPlot_PlotPieChart_U32PtrPlotFormatter(label_ids, values, count, x, y, radius, fmt, fmt_data, angle0, spec)
end
function M.ImPlot_PlotPieChart_S64PtrPlotFormatter(label_ids, values, count, x, y, radius, fmt, fmt_data, angle0, spec)
    angle0 = angle0 or 90
    fmt_data = fmt_data or nil
    spec = spec or M.ImPlotSpec()[0]
    return lib.ImPlot_PlotPieChart_S64PtrPlotFormatter(label_ids, values, count, x, y, radius, fmt, fmt_data, angle0, spec)
end
function M.ImPlot_PlotPieChart_U64PtrPlotFormatter(label_ids, values, count, x, y, radius, fmt, fmt_data, angle0, spec)
    angle0 = angle0 or 90
    fmt_data = fmt_data or nil
    spec = spec or M.ImPlotSpec()[0]
    return lib.ImPlot_PlotPieChart_U64PtrPlotFormatter(label_ids, values, count, x, y, radius, fmt, fmt_data, angle0, spec)
end
...
function M.ImPlot_PlotPieChart(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10)
    -- generic version
    if (ffi.istype('float*', a2) or ffi.istype('float[]', a2)) and ffi.istype('ImPlotFormatter', a7) and (ffi.istype('void *', a8) or type(a8) == 'nil') and (ffi.istype('const ImPlotSpec', a10) or type(a10) == 'nil') and ((ffi.istype('double', a9) or type(a9) == 'number') or type(a9) == 'nil') then
        return M.ImPlot_PlotPieChart_FloatPtrPlotFormatter(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10)
    end
    if (ffi.istype('double*', a2) or ffi.istype('double[]', a2)) and ffi.istype('ImPlotFormatter', a7) and (ffi.istype('void *', a8) or type(a8) == 'nil') and (ffi.istype('const ImPlotSpec', a10) or type(a10) == 'nil') and ((ffi.istype('double', a9) or type(a9) == 'number') or type(a9) == 'nil') then
        return M.ImPlot_PlotPieChart_doublePtrPlotFormatter(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10)
    end
    if (ffi.istype('const ImS8*', a2) or ffi.istype('char[]', a2) or type(a2) == 'string') and ffi.istype('ImPlotFormatter', a7) and (ffi.istype('void *', a8) or type(a8) == 'nil') and (ffi.istype('const ImPlotSpec', a10) or type(a10) == 'nil') and ((ffi.istype('double', a9) or type(a9) == 'number') or type(a9) == 'nil') then
        return M.ImPlot_PlotPieChart_S8PtrPlotFormatter(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10)
    end
    if ffi.typeof('uint8_t*') == ffi.typeof(a2) or ffi.typeof('const uint8_t*') == ffi.typeof(a2) or ffi.typeof('uint8_t[?]') == ffi.typeof(a2) or ffi.typeof('const uint8_t[?]') == ffi.typeof(a2) and ffi.istype('ImPlotFormatter', a7) and (ffi.istype('void *', a8) or type(a8) == 'nil') and (ffi.istype('const ImPlotSpec', a10) or type(a10) == 'nil') and ((ffi.istype('double', a9) or type(a9) == 'number') or type(a9) == 'nil') then
        return M.ImPlot_PlotPieChart_U8PtrPlotFormatter(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10)
    end
    if ffi.typeof('int16_t*') == ffi.typeof(a2) or ffi.typeof('const int16_t*') == ffi.typeof(a2) or ffi.typeof('int16_t[?]') == ffi.typeof(a2) or ffi.typeof('const int16_t[?]') == ffi.typeof(a2) and ffi.istype('ImPlotFormatter', a7) and (ffi.istype('void *', a8) or type(a8) == 'nil') and (ffi.istype('const ImPlotSpec', a10) or type(a10) == 'nil') and ((ffi.istype('double', a9) or type(a9) == 'number') or type(a9) == 'nil') then
        return M.ImPlot_PlotPieChart_S16PtrPlotFormatter(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10)
    end
    if ffi.typeof('uint16_t*') == ffi.typeof(a2) or ffi.typeof('const uint16_t*') == ffi.typeof(a2) or ffi.typeof('uint16_t[?]') == ffi.typeof(a2) or ffi.typeof('const uint16_t[?]') == ffi.typeof(a2) and ffi.istype('ImPlotFormatter', a7) and (ffi.istype('void *', a8) or type(a8) == 'nil') and (ffi.istype('const ImPlotSpec', a10) or type(a10) == 'nil') and ((ffi.istype('double', a9) or type(a9) == 'number') or type(a9) == 'nil') then
        return M.ImPlot_PlotPieChart_U16PtrPlotFormatter(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10)
    end
    if ffi.typeof('int32_t*') == ffi.typeof(a2) or ffi.typeof('const int32_t*') == ffi.typeof(a2) or ffi.typeof('int32_t[?]') == ffi.typeof(a2) or ffi.typeof('const int32_t[?]') == ffi.typeof(a2) and ffi.istype('ImPlotFormatter', a7) and (ffi.istype('void *', a8) or type(a8) == 'nil') and (ffi.istype('const ImPlotSpec', a10) or type(a10) == 'nil') and ((ffi.istype('double', a9) or type(a9) == 'number') or type(a9) == 'nil') then
        return M.ImPlot_PlotPieChart_S32PtrPlotFormatter(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10)
    end
    if ffi.typeof('uint32_t*') == ffi.typeof(a2) or ffi.typeof('const uint32_t*') == ffi.typeof(a2) or ffi.typeof('uint32_t[?]') == ffi.typeof(a2) or ffi.typeof('const uint32_t[?]') == ffi.typeof(a2) and ffi.istype('ImPlotFormatter', a7) and (ffi.istype('void *', a8) or type(a8) == 'nil') and (ffi.istype('const ImPlotSpec', a10) or type(a10) == 'nil') and ((ffi.istype('double', a9) or type(a9) == 'number') or type(a9) == 'nil') then
        return M.ImPlot_PlotPieChart_U32PtrPlotFormatter(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10)
    end
    if (ffi.istype('const ImS64*', a2) or ffi.istype('const ImS64', a2) or ffi.istype('const ImS64[]', a2)) and ffi.istype('ImPlotFormatter', a7) and (ffi.istype('void *', a8) or type(a8) == 'nil') and (ffi.istype('const ImPlotSpec', a10) or type(a10) == 'nil') and ((ffi.istype('double', a9) or type(a9) == 'number') or type(a9) == 'nil') then
        return M.ImPlot_PlotPieChart_S64PtrPlotFormatter(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10)
    end
    if (ffi.istype('const ImU64*', a2) or ffi.istype('const ImU64', a2) or ffi.istype('const ImU64[]', a2)) and ffi.istype('ImPlotFormatter', a7) and (ffi.istype('void *', a8) or type(a8) == 'nil') and (ffi.istype('const ImPlotSpec', a10) or type(a10) == 'nil') and ((ffi.istype('double', a9) or type(a9) == 'number') or type(a9) == 'nil') then
        return M.ImPlot_PlotPieChart_U64PtrPlotFormatter(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10)
    end
    if (ffi.istype('float*', a2) or ffi.istype('float[]', a2)) and ((ffi.istype('const char*', a7) or ffi.istype('char[]', a7) or type(a7) == 'string') or type(a7) == 'nil') and ((ffi.istype('double', a8) or type(a8) == 'number') or type(a8) == 'nil') and a10 == nil and (ffi.istype('const ImPlotSpec', a9) or type(a9) == 'nil') then
        return M.ImPlot_PlotPieChart_FloatPtrStr(a1, a2, a3, a4, a5, a6, a7, a8, a9)
    end
    if (ffi.istype('double*', a2) or ffi.istype('double[]', a2)) and ((ffi.istype('const char*', a7) or ffi.istype('char[]', a7) or type(a7) == 'string') or type(a7) == 'nil') and ((ffi.istype('double', a8) or type(a8) == 'number') or type(a8) == 'nil') and a10 == nil and (ffi.istype('const ImPlotSpec', a9) or type(a9) == 'nil') then
        return M.ImPlot_PlotPieChart_doublePtrStr(a1, a2, a3, a4, a5, a6, a7, a8, a9)
    end
    if (ffi.istype('const ImS8*', a2) or ffi.istype('char[]', a2) or type(a2) == 'string') and ((ffi.istype('const char*', a7) or ffi.istype('char[]', a7) or type(a7) == 'string') or type(a7) == 'nil') and ((ffi.istype('double', a8) or type(a8) == 'number') or type(a8) == 'nil') and a10 == nil and (ffi.istype('const ImPlotSpec', a9) or type(a9) == 'nil') then
        return M.ImPlot_PlotPieChart_S8PtrStr(a1, a2, a3, a4, a5, a6, a7, a8, a9)
    end
    if ffi.typeof('uint8_t*') == ffi.typeof(a2) or ffi.typeof('const uint8_t*') == ffi.typeof(a2) or ffi.typeof('uint8_t[?]') == ffi.typeof(a2) or ffi.typeof('const uint8_t[?]') == ffi.typeof(a2) and ((ffi.istype('const char*', a7) or ffi.istype('char[]', a7) or type(a7) == 'string') or type(a7) == 'nil') and ((ffi.istype('double', a8) or type(a8) == 'number') or type(a8) == 'nil') and a10 == nil and (ffi.istype('const ImPlotSpec', a9) or type(a9) == 'nil') then
    ...
    if (ffi.istype('const ImS64*', a2) or ffi.istype('const ImS64', a2) or ffi.istype('const ImS64[]', a2)) and ((ffi.istype('const char*', a7) or ffi.istype('char[]', a7) or type(a7) == 'string') or type(a7) == 'nil') and ((ffi.istype('double', a8) or type(a8) == 'number') or type(a8) == 'nil') and a10 == nil and (ffi.istype('const ImPlotSpec', a9) or type(a9) == 'nil') then
        return M.ImPlot_PlotPieChart_S64PtrStr(a1, a2, a3, a4, a5, a6, a7, a8, a9)
    end
    if (ffi.istype('const ImU64*', a2) or ffi.istype('const ImU64', a2) or ffi.istype('const ImU64[]', a2)) and ((ffi.istype('const char*', a7) or ffi.istype('char[]', a7) or type(a7) == 'string') or type(a7) == 'nil') and ((ffi.istype('double', a8) or type(a8) == 'number') or type(a8) == 'nil') and a10 == nil and (ffi.istype('const ImPlotSpec', a9) or type(a9) == 'nil') then
...
function M.ImPlot_PlotPolygon(a1, a2, a3, a4, a5)
    -- generic version
    if (ffi.istype('float*', a2) or ffi.istype('float[]', a2)) then
...
function M.ImPlot_PlotScatter(a1, a2, a3, a4, a5, a6)
    -- generic version
    if (ffi.istype('float*', a2) or ffi.istype('float[]', a2)) and (ffi.istype('int32_t', a3) or type(a3) == 'number') then
...
function M.ImPlot_PlotShaded(a1, a2, a3, a4, a5, a6, a7)
    -- generic version
    if (ffi.istype('float*', a2) or ffi.istype('float[]', a2)) and (ffi.istype('int32_t', a3) or type(a3) == 'number') and ((ffi.istype('double', a4) or type(a4) == 'number') or type(a4) == 'nil') and ((ffi.istype('double', a6) or type(a6) == 'number') or type(a6) == 'nil') and (ffi.istype('const ImPlotSpec', a7) or type(a7) == 'nil') then
        return M.ImPlot_PlotShaded_FloatPtrInt(a1, a2, a3, a4, a5, a6, a7)
    end
    if (ffi.istype('double*', a2) or ffi.istype('double[]', a2)) and (ffi.istype('int32_t', a3) or type(a3) == 'number') and ((ffi.istype('double', a4) or type(a4) == 'number') or type(a4) == 'nil') and ((ffi.istype('double', a6) or type(a6) == 'number') or type(a6) == 'nil') and (ffi.istype('const ImPlotSpec', a7) or type(a7) == 'nil') then
        return M.ImPlot_PlotShaded_doublePtrInt(a1, a2, a3, a4, a5, a6, a7)
    end
    if (ffi.istype('const ImS8*', a2) or ffi.istype('char[]', a2) or type(a2) == 'string') and (ffi.istype('int32_t', a3) or type(a3) == 'number') and ((ffi.istype('double', a4) or type(a4) == 'number') or type(a4) == 'nil') and ((ffi.istype('double', a6) or type(a6) == 'number') or type(a6) == 'nil') and (ffi.istype('const ImPlotSpec', a7) or type(a7) == 'nil') then
        return M.ImPlot_PlotShaded_S8PtrInt(a1, a2, a3, a4, a5, a6, a7)
    end
    if ffi.typeof('uint8_t*') == ffi.typeof(a2) or ffi.typeof('const uint8_t*') == ffi.typeof(a2) or ffi.typeof('uint8_t[?]') == ffi.typeof(a2) or ffi.typeof('const uint8_t[?]') == ffi.typeof(a2) and (ffi.istype('int32_t', a3) or type(a3) == 'number') and ((ffi.istype('double', a4) or type(a4) == 'number') or type(a4) == 'nil') and ((ffi.istype('double', a6) or type(a6) == 'number') or type(a6) == 'nil') and (ffi.istype('const ImPlotSpec', a7) or type(a7) == 'nil') then
        return M.ImPlot_PlotShaded_U8PtrInt(a1, a2, a3, a4, a5, a6, a7)
    end
    if ffi.typeof('int16_t*') == ffi.typeof(a2) or ffi.typeof('const int16_t*') == ffi.typeof(a2) or ffi.typeof('int16_t[?]') == ffi.typeof(a2) or ffi.typeof('const int16_t[?]') == ffi.typeof(a2) and (ffi.istype('int32_t', a3) or type(a3) == 'number') and ((ffi.istype('double', a4) or type(a4) == 'number') or type(a4) == 'nil') and ((ffi.istype('double', a6) or type(a6) == 'number') or type(a6) == 'nil') and (ffi.istype('const ImPlotSpec', a7) or type(a7) == 'nil') then
        return M.ImPlot_PlotShaded_S16PtrInt(a1, a2, a3, a4, a5, a6, a7)
    end
    if ffi.typeof('uint16_t*') == ffi.typeof(a2) or ffi.typeof('const uint16_t*') == ffi.typeof(a2) or ffi.typeof('uint16_t[?]') == ffi.typeof(a2) or ffi.typeof('const uint16_t[?]') == ffi.typeof(a2) and (ffi.istype('int32_t', a3) or type(a3) == 'number') and ((ffi.istype('double', a4) or type(a4) == 'number') or type(a4) == 'nil') and ((ffi.istype('double', a6) or type(a6) == 'number') or type(a6) == 'nil') and (ffi.istype('const ImPlotSpec', a7) or type(a7) == 'nil') then
        return M.ImPlot_PlotShaded_U16PtrInt(a1, a2, a3, a4, a5, a6, a7)
    end
    if ffi.typeof('int32_t*') == ffi.typeof(a2) or ffi.typeof('const int32_t*') == ffi.typeof(a2) or ffi.typeof('int32_t[?]') == ffi.typeof(a2) or ffi.typeof('const int32_t[?]') == ffi.typeof(a2) and (ffi.istype('int32_t', a3) or type(a3) == 'number') and ((ffi.istype('double', a4) or type(a4) == 'number') or type(a4) == 'nil') and ((ffi.istype('double', a6) or type(a6) == 'number') or type(a6) == 'nil') and (ffi.istype('const ImPlotSpec', a7) or type(a7) == 'nil') then
        return M.ImPlot_PlotShaded_S32PtrInt(a1, a2, a3, a4, a5, a6, a7)
    end
    if ffi.typeof('uint32_t*') == ffi.typeof(a2) or ffi.typeof('const uint32_t*') == ffi.typeof(a2) or ffi.typeof('uint32_t[?]') == ffi.typeof(a2) or ffi.typeof('const uint32_t[?]') == ffi.typeof(a2) and (ffi.istype('int32_t', a3) or type(a3) == 'number') and ((ffi.istype('double', a4) or type(a4) == 'number') or type(a4) == 'nil') and ((ffi.istype('double', a6) or type(a6) == 'number') or type(a6) == 'nil') and (ffi.istype('const ImPlotSpec', a7) or type(a7) == 'nil') then
        return M.ImPlot_PlotShaded_U32PtrInt(a1, a2, a3, a4, a5, a6, a7)
    end
    if (ffi.istype('const ImS64*', a2) or ffi.istype('const ImS64', a2) or ffi.istype('const ImS64[]', a2)) and (ffi.istype('int32_t', a3) or type(a3) == 'number') and ((ffi.istype('double', a4) or type(a4) == 'number') or type(a4) == 'nil') and ((ffi.istype('double', a6) or type(a6) == 'number') or type(a6) == 'nil') and (ffi.istype('const ImPlotSpec', a7) or type(a7) == 'nil') then
        return M.ImPlot_PlotShaded_S64PtrInt(a1, a2, a3, a4, a5, a6, a7)
    end
    if (ffi.istype('const ImU64*', a2) or ffi.istype('const ImU64', a2) or ffi.istype('const ImU64[]', a2)) and (ffi.istype('int32_t', a3) or type(a3) == 'number') and ((ffi.istype('double', a4) or type(a4) == 'number') or type(a4) == 'nil') and ((ffi.istype('double', a6) or type(a6) == 'number') or type(a6) == 'nil') and (ffi.istype('const ImPlotSpec', a7) or type(a7) == 'nil') then
        return M.ImPlot_PlotShaded_U64PtrInt(a1, a2, a3, a4, a5, a6, a7)
    end
    if (ffi.istype('float*', a2) or ffi.istype('float[]', a2)) and (ffi.istype('float*', a3) or ffi.istype('float[]', a3)) and (ffi.istype('int32_t', a4) or type(a4) == 'number') and (ffi.istype('const ImPlotSpec', a6) or type(a6) == 'nil') and a7 == nil then
        return M.ImPlot_PlotShaded_FloatPtrFloatPtrInt(a1, a2, a3, a4, a5, a6)
    end
    if (ffi.istype('double*', a2) or ffi.istype('double[]', a2)) and (ffi.istype('double*', a3) or ffi.istype('double[]', a3)) and (ffi.istype('int32_t', a4) or type(a4) == 'number') and (ffi.istype('const ImPlotSpec', a6) or type(a6) == 'nil') and a7 == nil then
        return M.ImPlot_PlotShaded_doublePtrdoublePtrInt(a1, a2, a3, a4, a5, a6)
    end
    if (ffi.istype('const ImS8*', a2) or ffi.istype('char[]', a2) or type(a2) == 'string') and (ffi.istype('const ImS8*', a3) or ffi.istype('char[]', a3) or type(a3) == 'string') and (ffi.istype('int32_t', a4) or type(a4) == 'number') and (ffi.istype('const ImPlotSpec', a6) or type(a6) == 'nil') and a7 == nil then
        return M.ImPlot_PlotShaded_S8PtrS8PtrInt(a1, a2, a3, a4, a5, a6)
    end
    if ffi.typeof('uint8_t*') == ffi.typeof(a2) or ffi.typeof('const uint8_t*') == ffi.typeof(a2) or ffi.typeof('uint8_t[?]') == ffi.typeof(a2) or ffi.typeof('const uint8_t[?]') == ffi.typeof(a2) and ffi.typeof('uint8_t*') == ffi.typeof(a3) or ffi.typeof('const uint8_t*') == ffi.typeof(a3) or ffi.typeof('uint8_t[?]') == ffi.typeof(a3) or ffi.typeof('const uint8_t[?]') == ffi.typeof(a3) and (ffi.istype('int32_t', a4) or type(a4) == 'number') and (ffi.istype('const ImPlotSpec', a6) or type(a6) == 'nil') and a7 == nil then
        return M.ImPlot_PlotShaded_U8PtrU8PtrInt(a1, a2, a3, a4, a5, a6)
    end
    if ffi.typeof('int16_t*') == ffi.typeof(a2) or ffi.typeof('const int16_t*') == ffi.typeof(a2) or ffi.typeof('int16_t[?]') == ffi.typeof(a2) or ffi.typeof('const int16_t[?]') == ffi.typeof(a2) and ffi.typeof('int16_t*') == ffi.typeof(a3) or ffi.typeof('const int16_t*') == ffi.typeof(a3) or ffi.typeof('int16_t[?]') == ffi.typeof(a3) or ffi.typeof('const int16_t[?]') == ffi.typeof(a3) and (ffi.istype('int32_t', a4) or type(a4) == 'number') and (ffi.istype('const ImPlotSpec', a6) or type(a6) == 'nil') and a7 == nil then
        return M.ImPlot_PlotShaded_S16PtrS16PtrInt(a1, a2, a3, a4, a5, a6)
    end
    if ffi.typeof('uint16_t*') == ffi.typeof(a2) or ffi.typeof('const uint16_t*') == ffi.typeof(a2) or ffi.typeof('uint16_t[?]') == ffi.typeof(a2) or ffi.typeof('const uint16_t[?]') == ffi.typeof(a2) and ffi.typeof('uint16_t*') == ffi.typeof(a3) or ffi.typeof('const uint16_t*') == ffi.typeof(a3) or ffi.typeof('uint16_t[?]') == ffi.typeof(a3) or ffi.typeof('const uint16_t[?]') == ffi.typeof(a3) and (ffi.istype('int32_t', a4) or type(a4) == 'number') and (ffi.istype('const ImPlotSpec', a6) or type(a6) == 'nil') and a7 == nil then
        return M.ImPlot_PlotShaded_U16PtrU16PtrInt(a1, a2, a3, a4, a5, a6)
    end
    if ffi.typeof('int32_t*') == ffi.typeof(a2) or ffi.typeof('const int32_t*') == ffi.typeof(a2) or ffi.typeof('int32_t[?]') == ffi.typeof(a2) or ffi.typeof('const int32_t[?]') == ffi.typeof(a2) and ffi.typeof('int32_t*') == ffi.typeof(a3) or ffi.typeof('const int32_t*') == ffi.typeof(a3) or ffi.typeof('int32_t[?]') == ffi.typeof(a3) or ffi.typeof('const int32_t[?]') == ffi.typeof(a3) and (ffi.istype('int32_t', a4) or type(a4) == 'number') and (ffi.istype('const ImPlotSpec', a6) or type(a6) == 'nil') and a7 == nil then
        return M.ImPlot_PlotShaded_S32PtrS32PtrInt(a1, a2, a3, a4, a5, a6)
    end
    if ffi.typeof('uint32_t*') == ffi.typeof(a2) or ffi.typeof('const uint32_t*') == ffi.typeof(a2) or ffi.typeof('uint32_t[?]') == ffi.typeof(a2) or ffi.typeof('const uint32_t[?]') == ffi.typeof(a2) and ffi.typeof('uint32_t*') == ffi.typeof(a3) or ffi.typeof('const uint32_t*') == ffi.typeof(a3) or ffi.typeof('uint32_t[?]') == ffi.typeof(a3) or ffi.typeof('const uint32_t[?]') == ffi.typeof(a3) and (ffi.istype('int32_t', a4) or type(a4) == 'number') and (ffi.istype('const ImPlotSpec', a6) or type(a6) == 'nil') and a7 == nil then
        return M.ImPlot_PlotShaded_U32PtrU32PtrInt(a1, a2, a3, a4, a5, a6)
    end
    if (ffi.istype('const ImS64*', a2) or ffi.istype('const ImS64', a2) or ffi.istype('const ImS64[]', a2)) and (ffi.istype('const ImS64*', a3) or ffi.istype('const ImS64', a3) or ffi.istype('const ImS64[]', a3)) and (ffi.istype('int32_t', a4) or type(a4) == 'number') and (ffi.istype('const ImPlotSpec', a6) or type(a6) == 'nil') and a7 == nil then
        return M.ImPlot_PlotShaded_S64PtrS64PtrInt(a1, a2, a3, a4, a5, a6)
    end
    if (ffi.istype('const ImU64*', a2) or ffi.istype('const ImU64', a2) or ffi.istype('const ImU64[]', a2)) and (ffi.istype('const ImU64*', a3) or ffi.istype('const ImU64', a3) or ffi.istype('const ImU64[]', a3)) and (ffi.istype('int32_t', a4) or type(a4) == 'number') and (ffi.istype('const ImPlotSpec', a6) or type(a6) == 'nil') and a7 == nil then
...
function M.ImPlot_PlotStairs(a1, a2, a3, a4, a5, a6)
    -- generic version
    if (ffi.istype('float*', a2) or ffi.istype('float[]', a2)) and (ffi.istype('int32_t', a3) or type(a3) == 'number') then
...
function M.ImPlot_PlotStems(a1, a2, a3, a4, a5, a6, a7)
    -- generic version
    if (ffi.istype('float*', a2) or ffi.istype('float[]', a2)) and (ffi.istype('int32_t', a3) or type(a3) == 'number') then
...
function M.ImPlot_PlotToPixels(a1, a2, a3, a4)
    -- generic version
...
function M.ImPlot_PushColormap(a1)
    -- generic version
    if (ffi.istype('int32_t', a1) or type(a1) == 'number') then
...
function M.ImPlot_PushStyleColor(a1, a2)
    -- generic version
    if (ffi.istype('uint32_t', a2) or type(a2) == 'number') then
...
function M.ImPlot_PushStyleVar(a1, a2)
    -- generic version
    if (ffi.istype('float', a2) or type(a2) == 'number') then
...
function M.ImPlot_SetupAxisFormat(a1, a2, a3)
    -- generic version
    if (ffi.istype('const char*', a2) or ffi.istype('char[]', a2) or type(a2) == 'string') then
...
function M.ImPlot_SetupAxisScale(a1, a2, a3, a4)
    -- generic version
    if (ffi.istype('int32_t', a2) or type(a2) == 'number') then
...
function M.ImPlot_SetupAxisTicks(a1, a2, a3, a4, a5, a6)
    -- generic version
    if (ffi.istype('double*', a2) or ffi.istype('double[]', a2)) then
...
function M.ImPlot_TagX(a1, a2, a3, ...)
    -- generic version
...
function M.ImPlot_TagY(a1, a2, a3, ...)
    -- generic version
    if ((ffi.istype('bool', a3) or type(a3) == 'boolean') or type(a3) == 'nil') then
...
function M.ax_NodeEditor_AcceptNewItem(a1, a2)
    -- generic version
    if a1 == nil then
...
function M.ax_NodeEditor_BreakLinks(a1)
    -- generic version
...
function M.ax_NodeEditor_HasAnyLinks(a1)
    -- generic version
    if ffi.istype('NodeId', a1) then
...
function M.ax_NodeEditor_PushStyleVar(a1, a2)
    -- generic version
    if (ffi.istype('float', a2) or type(a2) == 'number') then
...
function M.ax_NodeEditor_QueryNewLink(a1, a2, a3, a4)
    -- generic version
    if a3 == nil then
...
function M.ax_NodeEditor_QueryNewNode(a1, a2, a3)
    -- generic version
    if a2 == nil then
...
function M.ax_NodeEditor_RejectNewItem(a1, a2)
    -- generic version
    if a1 == nil then
...
function M.BeginChild(a1, a2, a3, a4)
    -- generic version
    if (ffi.istype('const char*', a1) or ffi.istype('char[]', a1) or type(a1) == 'string') then
...
function M.CheckboxFlags(a1, a2, a3)
    -- generic version
    if ffi.typeof('int32_t*') == ffi.typeof(a2) or ffi.typeof('const int32_t*') == ffi.typeof(a2) or ffi.typeof('int32_t[?]') == ffi.typeof(a2) or ffi.typeof('const int32_t[?]') == ffi.typeof(a2) then
    ...
    if (ffi.istype('ImS64*', a2) or ffi.istype('ImS64', a2) or ffi.istype('ImS64[]', a2)) then
        return M.CheckboxFlags_S64Ptr(a1, a2, a3)
    end
    if (ffi.istype('ImU64*', a2) or ffi.istype('ImU64', a2) or ffi.istype('ImU64[]', a2)) then
...
function M.Combo(a1, a2, a3, a4, a5, a6)
    -- generic version
    if (ffi.istype('const char* const[]', a3) or ffi.istype('const char const[]', a3) or ffi.istype('const char const[][]', a3)) then
...
function M.GetForegroundDrawList(a1)
    -- generic version
    if ((ffi.istype('ImGuiViewport*', a1) or ffi.istype('ImGuiViewport', a1) or ffi.istype('ImGuiViewport[]', a1)) or type(a1) == 'nil') then
...
function M.GetIDWithSeed(a1, a2, a3)
    -- generic version
    if (ffi.istype('const char*', a1) or ffi.istype('char[]', a1) or type(a1) == 'string') then
...
function M.IsKeyChordPressed(a1, a2, a3)
    -- generic version
    if a2 == nil then
...
function M.IsKeyPressed(a1, a2, a3)
    -- generic version
...
function M.IsKeyReleased(a1, a2)
    -- generic version
    if a2 == nil then
...
function M.IsMouseClicked(a1, a2, a3)
    -- generic version
    if ((ffi.istype('bool', a2) or type(a2) == 'boolean') or type(a2) == 'nil') then
...
function M.IsMouseDoubleClicked(a1, a2)
    -- generic version
    if a2 == nil then
...
function M.IsMouseReleased(a1, a2)
    -- generic version
    if a2 == nil then
...
function M.IsRectVisible(a1, a2)
    -- generic version
    if a2 == nil then
...
function M.ListBox(a1, a2, a3, a4, a5, a6)
    -- generic version
    if (ffi.istype('const char* const[]', a3) or ffi.istype('const char const[]', a3) or ffi.istype('const char const[][]', a3)) then
...
function M.MarkIniSettingsDirty(a1)
    -- generic version
    if a1 == nil then
...
function M.MenuItem(a1, a2, a3, a4)
    -- generic version
    if ((ffi.istype('bool', a3) or type(a3) == 'boolean') or type(a3) == 'nil') then
...
function M.PlotHistogram(a1, a2, a3, a4, a5, a6, a7, a8, a9)
    -- generic version
    if (ffi.istype('float*', a2) or ffi.istype('float[]', a2)) then
...
function M.PlotLines(a1, a2, a3, a4, a5, a6, a7, a8, a9)
    -- generic version
    if (ffi.istype('float*', a2) or ffi.istype('float[]', a2)) then
...
function M.PushStyleColor(a1, a2)
    -- generic version
    if (ffi.istype('uint32_t', a2) or type(a2) == 'number') then
...
function M.Selectable(a1, a2, a3, a4)
    -- generic version
    if ((ffi.istype('bool', a2) or type(a2) == 'boolean') or type(a2) == 'nil') then
...
function M.SetItemKeyOwner(a1, a2)
    -- generic version
    if a2 == nil then
...
function M.SetScrollFromPosX(a1, a2, a3)
    -- generic version
    if (ffi.istype('float', a1) or type(a1) == 'number') then
...
function M.SetScrollFromPosY(a1, a2, a3)
    -- generic version
    if (ffi.istype('float', a1) or type(a1) == 'number') then
...
function M.SetWindowPos(a1, a2, a3)
    -- generic version
    if ffi.istype('const ImVec2', a1) then
...
function M.SetWindowSize(a1, a2, a3)
    -- generic version
    if ffi.istype('const ImVec2', a1) then
...
function M.TabBarQueueFocus(a1, a2)
    -- generic version
...
function M.TabItemCalcSize(a1, a2)
    -- generic version
    if (ffi.istype('const char*', a1) or ffi.istype('char[]', a1) or type(a1) == 'string') then
...
function M.TableGcCompactTransientBuffers(a1)
    -- generic version
    ...
    if (ffi.istype('ImGuiTableTempData*', a1) or ffi.istype('ImGuiTableTempData', a1) or ffi.istype('ImGuiTableTempData[]', a1)) then
...
function M.TableGetColumnName(a1, a2)
    -- generic version
    if ((ffi.istype('int32_t', a1) or type(a1) == 'number') or type(a1) == 'nil') then
        return M.TableGetColumnName_Int(a1)
    end
    if (ffi.istype('const ImGuiTable*', a1) or ffi.istype('const ImGuiTable', a1) or ffi.istype('const ImGuiTable[]', a1)) then
...
function M.TreeNodeEx(a1, a2, a3, ...)
    -- generic version
    if (ffi.istype('const char*', a1) or ffi.istype('char[]', a1) or type(a1) == 'string') and a3 == nil then
        return M.TreeNodeEx_Str(a1, a2)
    end
    if (ffi.istype('const char*', a1) or ffi.istype('char[]', a1) or type(a1) == 'string') and (ffi.istype('const char*', a3) or ffi.istype('char[]', a3) or type(a3) == 'string') then
...
function M.TreeNodeExV(a1, a2, a3, a4)
    -- generic version
    if (ffi.istype('const char*', a1) or ffi.istype('char[]', a1) or type(a1) == 'string') then
...
function M.gizmo3D(a1, a2, a3, a4, a5, a6)
    -- generic version
    if (ffi.istype('quat*', a2) or ffi.istype('quat', a2) or ffi.istype('quat[]', a2)) and (ffi.istype('float', a3) or type(a3) == 'number') and ((ffi.istype('uint32_t', a4) or type(a4) == 'number') or type(a4) == 'nil') and a5 == nil then
    ...
    if (ffi.istype('vec3*', a2) or ffi.istype('vec3', a2) or ffi.istype('vec3[]', a2)) and (ffi.istype('float', a3) or type(a3) == 'number') and ((ffi.istype('uint32_t', a4) or type(a4) == 'number') or type(a4) == 'nil') and a5 == nil then
        return M.gizmo3D_vec3PtrFloat(a1, a2, a3, a4)
    end
    if (ffi.istype('quat*', a2) or ffi.istype('quat', a2) or ffi.istype('quat[]', a2)) and (ffi.istype('quat*', a3) or ffi.istype('quat', a3) or ffi.istype('quat[]', a3)) and (ffi.istype('float', a4) or type(a4) == 'number') and ((ffi.istype('uint32_t', a5) or type(a5) == 'number') or type(a5) == 'nil') then
        return M.gizmo3D_quatPtrquatPtr(a1, a2, a3, a4, a5)
    end
    if (ffi.istype('quat*', a2) or ffi.istype('quat', a2) or ffi.istype('quat[]', a2)) and (ffi.istype('vec4*', a3) or ffi.istype('vec4', a3) or ffi.istype('vec4[]', a3)) and (ffi.istype('float', a4) or type(a4) == 'number') and ((ffi.istype('uint32_t', a5) or type(a5) == 'number') or type(a5) == 'nil') then
        return M.gizmo3D_quatPtrvec4Ptr(a1, a2, a3, a4, a5)
    end
    if (ffi.istype('quat*', a2) or ffi.istype('quat', a2) or ffi.istype('quat[]', a2)) and (ffi.istype('vec3*', a3) or ffi.istype('vec3', a3) or ffi.istype('vec3[]', a3)) and (ffi.istype('float', a4) or type(a4) == 'number') and ((ffi.istype('uint32_t', a5) or type(a5) == 'number') or type(a5) == 'nil') then
        return M.gizmo3D_quatPtrvec3Ptr(a1, a2, a3, a4, a5)
    end
    if (ffi.istype('vec3*', a2) or ffi.istype('vec3', a2) or ffi.istype('vec3[]', a2)) and (ffi.istype('quat*', a3) or ffi.istype('quat', a3) or ffi.istype('quat[]', a3)) and (ffi.istype('float', a4) or type(a4) == 'number') and ((ffi.istype('uint32_t', a5) or type(a5) == 'number') or type(a5) == 'nil') then
        return M.gizmo3D_vec3PtrquatPtrFloat(a1, a2, a3, a4, a5)
    end
    if (ffi.istype('vec3*', a2) or ffi.istype('vec3', a2) or ffi.istype('vec3[]', a2)) and (ffi.istype('vec4*', a3) or ffi.istype('vec4', a3) or ffi.istype('vec4[]', a3)) and (ffi.istype('float', a4) or type(a4) == 'number') and ((ffi.istype('uint32_t', a5) or type(a5) == 'number') or type(a5) == 'nil') then
        return M.gizmo3D_vec3Ptrvec4Ptr(a1, a2, a3, a4, a5)
    end
    if (ffi.istype('vec3*', a2) or ffi.istype('vec3', a2) or ffi.istype('vec3[]', a2)) and (ffi.istype('vec3*', a3) or ffi.istype('vec3', a3) or ffi.istype('vec3[]', a3)) and (ffi.istype('float', a4) or type(a4) == 'number') and ((ffi.istype('uint32_t', a5) or type(a5) == 'number') or type(a5) == 'nil') then
        return M.gizmo3D_vec3Ptrvec3Ptr(a1, a2, a3, a4, a5)
    end
    if (ffi.istype('vec3*', a2) or ffi.istype('vec3', a2) or ffi.istype('vec3[]', a2)) and (ffi.istype('quat*', a3) or ffi.istype('quat', a3) or ffi.istype('quat[]', a3)) and (ffi.istype('quat*', a4) or ffi.istype('quat', a4) or ffi.istype('quat[]', a4)) then
        return M.gizmo3D_vec3PtrquatPtrquatPtr(a1, a2, a3, a4, a5, a6)
    end
    if (ffi.istype('vec3*', a2) or ffi.istype('vec3', a2) or ffi.istype('vec3[]', a2)) and (ffi.istype('quat*', a3) or ffi.istype('quat', a3) or ffi.istype('quat[]', a3)) and (ffi.istype('vec4*', a4) or ffi.istype('vec4', a4) or ffi.istype('vec4[]', a4)) then
        return M.gizmo3D_vec3PtrquatPtrvec4Ptr(a1, a2, a3, a4, a5, a6)
    end
    if (ffi.istype('vec3*', a2) or ffi.istype('vec3', a2) or ffi.istype('vec3[]', a2)) and (ffi.istype('quat*', a3) or ffi.istype('quat', a3) or ffi.istype('quat[]', a3)) and (ffi.istype('vec3*', a4) or ffi.istype('vec3', a4) or ffi.istype('vec3[]', a4)) then
...
function M.imnodes_ClearLinkSelection(a1)
    -- generic version
    if a1 == nil then
...
function M.imnodes_ClearNodeSelection(a1)
    -- generic version
    if a1 == nil then
...
function M.imnodes_IsLinkCreated(a1, a2, a3, a4, a5)
    -- generic version
    if ((ffi.istype('bool*', a3) or ffi.istype('bool[]', a3)) or type(a3) == 'nil') then
        return M.imnodes_IsLinkCreated_BoolPtr(a1, a2, a3)
    end
    if ffi.typeof('int32_t*') == ffi.typeof(a3) or ffi.typeof('const int32_t*') == ffi.typeof(a3) or ffi.typeof('int32_t[?]') == ffi.typeof(a3) or ffi.typeof('const int32_t[?]') == ffi.typeof(a3) then
...
function M.imnodes_PushStyleVar(a1, a2)
    -- generic version
    if (ffi.istype('float', a2) or type(a2) == 'number') then
