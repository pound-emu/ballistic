...
#define BAL_SLIDING_WINDOW_CAPACITY 4
    ...
    typedef enum
    {
        ...
        BAL_X86_MACRO_ADD_REGISTER_IMMEDIATE_32,
        BAL_X86_MACRO_ADD_REGISTER_REGISTER,
        BAL_X86_MACRO_ADD_REGISTER_REGISTER_32,
        ...
        BAL_X86_MACRO_SUB_REGISTER_IMMEDIATE_32,
        BAL_X86_MACRO_SUB_REGISTER_REGISTER,
        BAL_X86_MACRO_XUB_REGISTER_REGISTER_32,
